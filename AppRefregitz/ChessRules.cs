 ...
 * Mal Function of Check Color Detection at ObjectDangouring.****************************CU*****0.88**1**Risk Control************************<*>
 * Assignment of Check State at ObjectDangourCheckRemove Method Not Occured.**************CU*****0.88**1**Risk Control************************<*>
 * Table Incredible Content Leads to Undisirable Result in Check and ....*********RS**0.12**4**Managements and Cuation Programing*****(+)
 * CheckedMate Complexity Over Numbers Of Cores Compexity.************************CU*****0.88**1**Risk Control************************{*}
 * Alice Bridges King Statistic is misleading.************************************.CU*****0.88**1**Risk Control************************{*}
...
namespace AppRefregitz
{
    class ChessRules
    {
        ...
        //Constructor 
        public ChessRules(int Ki, int[,] A, int Ord, int i, int j)
        {
                        ...
                        for (int jj = 0; jj < 8; jj++)
                        {
                            ...
                            for (int iii = 0; iii < 8; iii++)
                            {
                                for (int jjj = 0; jjj < 8; jjj++)
                                {
                                    ...
                                    if (Tab[iii, jjj] < 0)
                                        continue;
                                    ThinkingChess AA = new ThinkingChess(ii, jj);
                                    ...
                                    if (AA.Attack(Tab, ii, jj, iii, jjj, Color.Brown, Order * -1))
                                    {
                                        ...
                                        for (int h = 0; h < 8; h++)
                                            for (int g = 0; g < 8; g++)
                                                Tabl[h, g] = Tab[h, g];
                                        ChessRules AAA = new ChessRules(Tabl[iii, jjj], Tabl, Order , iii, jjj);
        ...
        public String CreateStatistic(int[,] Tab, int Movments, int SourceThings, int Column, int Row, bool Hit, int HitThings, bool BridgeKing, bool SodierConvert//,ref FormRefrigtz THIS
            )
        {
            ...
            ChessRules A = new ChessRules(1, Tab, 1, Row, Column);
                        ...
                        else//Else of Condition.
                        {
                            ...
                            for (int ii = 0; ii < 8; ii++)
                                for (int jj = 0; jj < 8; jj++)
                                {
                                    ...
                                    if ((new ThinkingChess(i, j)).Movable(Table, i, j, ii, jj, A, Order))
                                    {
                            ...
                            for (int jj = 0; jj < 8; jj++)
                            {
                                ...
                                if (Table[i, j] < 0)
                                {
                                    ...
                                    if (Table[ii, jj] > 0)
                                    {
                                        ...
                                        //If Is Movable.
                                        if ((new ThinkingChess(i, j)).Movable(Tab, i, j, ii, jj, Color.Brown, -1))
                                        {
                                            //Clone a Copy.
                                            for (int iii = 0; iii < 8; iii++)
                                                for (int jjj = 0; jjj < 8; jjj++)
                            ...
                            for (int jj = 0; jj < 8; jj++)
                            {
                                ...
                                if (Table[i, j] > 0)
                                {
                                    ...
                                    if (Table[ii, jj] < 0)
                                    {
                                        ...
                                        if ((new ThinkingChess(i, j)).Movable(Tab, i, j, ii, jj, Color.Gray, 1))
                                        {
                                            for (int iii = 0; iii < 8; iii++)
                                                for (int jjj = 0; jjj < 8; jjj++)
                                                {
                    ...
                    for (int i = 0; i < 8; i++)
                        for (int j = 0; j < 8; j++)
                        {
                            ...
                            if (Tab[i, j] < 0)
                            {
                                ...
                                if ((new ThinkingChess(i, j)).Attack(Tab, i, j, RowG, ColumnG, Color.Brown, -1))
                                {
                    ...
                    for (int i = 0; i < 8; i++)
                        for (int j = 0; j < 8; j++)
                        {
                            ...
                            if (Tab[i, j] > 0)
                            {
                                ...
                                if ((new ThinkingChess(i, j)).Attack(Tab, i, j, RowB, ColumnB, Color.Gray, 1))
                                {
                    ...
                    for (int i = 0; i < 8; i++)
                    {
                        for (int j = 0; j < 8; j++)
                        {
                            ...
                            if (CheckGray)
                            {
                                ...
                                if ((new ThinkingChess(RowG, ColumnG)).Movable(Table, RowG, ColumnG, i, j, Color.Gray, 1))
                                {
                        ...
                        for (int j = 0; j < 8; j++)
                        {
                            ...
                            for (int ii = 0; ii < 8; ii++)
                            {
                                ...
                                for (int jj = 0; jj < 8; jj++)
                                {
                                    ...
                                    if ((new ThinkingChess(i, j)).Movable(Table, i, j, ii, jj, Color.Gray, 1))
                                    {
                    ...
                    for (int i = 0; i < 8; i++)
                    {
                        for (int j = 0; j < 8; j++)
                        {
                            ...
                            if (CheckGray)
                            {
                                ...
                                ChessRules.CurrentOrder = 1;
                                //Ig Gray King is Movable to First Home Table.
                                if ((new ThinkingChess(RowB, ColumnB)).Movable(Table, RowB, ColumnB, i, j, Color.Brown, -1))
                                {
                                    //Initaite Loval and Move.
                                    //ActMove = false;
                                    int Store = Table[i, j];
                                ...
                                for (int jj = 0; jj < 8; jj++)
                                {
                                    ...
                                    for (int iii = 0; iii < 8; iii++)
                                        for (int jjj = 0; jjj < 8; jjj++)
                                            Table[iii, jjj] = Tab[iii, jjj];
                                    //If First Home Table is Movable To Second Home Table.  
                                    if ((new ThinkingChess(i, j)).Movable(Table, i, j, ii, jj, Color.Brown, -1))
                                    {
                                        //Initiate Local Varibales and Move.
                                        //ActMoveF = false;
                                        //For Another Methods
