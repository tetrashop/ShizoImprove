    ...
    public class AllDraw
    {
        ...
        bool IsToCheckMateHasLessDeeperThanForCheckMate(AllDraw A, int Order, ref int ToCheckMate, ref int ForCheckMate, int AStarGreedy)
        {
            ...
            else
            {
                ...
                for (int i = AllDraw.MinisterMidle; i < MinisterHigh; i++)
                    for (int j = 0; A.MinisterOnTable[i] != null && A.MinisterOnTable[i].MinisterThinking[0] != null && j < A.MinisterOnTable[i].MinisterThinking[0].TableListMinister.Count; j++)
                    {
                ...
                for (int i = AllDraw.KingMidle; i < KingHigh; i++)
                    for (int j = 0; A.KingOnTable[i] != null && A.KingOnTable[i].KingThinking[0] != null && j < A.KingOnTable[i].KingThinking[0].TableListKing.Count; j++)
                    {
            ...
            if (Order == 1)
            {
                ...
                for (int i = 0; i < AllDraw.SodierMidle; i++)
                    for (int j = 0; SolderesOnTable[i] != null && SolderesOnTable[i].SoldierThinking[0] != null && j < SolderesOnTable[i].SoldierThinking[0].TableListSolder.Count; j++)
                    {
                        try
                        {
                            ...
                            AA = new ChessRules(SolderesOnTable[i].SoldierThinking[0].TableListSolder[j][SolderesOnTable[i].SoldierThinking[0].RowColumnSoldier[j][0], SolderesOnTable[i].SoldierThinking[0].RowColumnSoldier[j][1]]
                ...
                for (int i = 0; i < AllDraw.ElefantMidle; i++)
                    for (int j = 0; ElephantOnTable[i] != null && ElephantOnTable[i].ElefantThinking[0] != null && j < ElephantOnTable[i].ElefantThinking[0].TableListElefant.Count; j++)
                    {
                        ...
                        try
                        {
                            ...
                            AA = new ChessRules(ElephantOnTable[i].ElefantThinking[0].TableListElefant[j][ElephantOnTable[i].ElefantThinking[0].RowColumnElefant[j][0], ElephantOnTable[i].ElefantThinking[0].RowColumnElefant[j][1]]
                ...
                for (int i = 0; i < AllDraw.HourseMidle; i++)
                    for (int j = 0; HoursesOnTable[i] != null && HoursesOnTable[i].HourseThinking[0] != null && j < HoursesOnTable[i].HourseThinking[0].TableListHourse.Count; j++)
                    {
                        ...
                        try
                        {
                            ...
                            AA = new ChessRules(HoursesOnTable[i].HourseThinking[0].TableListHourse[j][HoursesOnTable[i].HourseThinking[0].RowColumnHourse[j][0], HoursesOnTable[i].HourseThinking[0].RowColumnHourse[j][1]]
                ...
                for (int i = 0; i < AllDraw.BridgeMidle; i++)
                    for (int j = 0; BridgesOnTable[i] != null && BridgesOnTable[i].BridgeThinking[0] != null && j < BridgesOnTable[i].BridgeThinking[0].TableListBridge.Count; j++)
                    {
                        ...
                        {
                            //Bridges Gray Rules.
                            AA = new ChessRules(BridgesOnTable[i].BridgeThinking[0].TableListBridge[j][BridgesOnTable[i].BridgeThinking[0].RowColumnBridge[j][0], BridgesOnTable[i].BridgeThinking[0].RowColumnBridge[j][1]]
                ...
                for (int i = 0; i < AllDraw.MinisterMidle; i++)
                    for (int j = 0; MinisterOnTable[i] != null && MinisterOnTable[i].MinisterThinking[0] != null && j < MinisterOnTable[i].MinisterThinking[0].TableListMinister.Count; j++)
                    {
                        ...
                        {
                            //Minister Gray Rules.
                            AA = new ChessRules(MinisterOnTable[i].MinisterThinking[0].TableListMinister[j][MinisterOnTable[i].MinisterThinking[0].RowColumnMinister[j][0], MinisterOnTable[i].MinisterThinking[0].RowColumnMinister[j][1]]
                ...
                for (int i = 0; i < AllDraw.KingMidle; i++)
                    for (int j = 0; KingOnTable[i] != null && KingOnTable[i].KingThinking[0] != null && j < KingOnTable[i].KingThinking[0].TableListKing.Count; j++)
                    {
                        ...
                        {
                            //Gray King Rules.
                            AA = new ChessRules(KingOnTable[i].KingThinking[0].TableListKing[j][KingOnTable[i].KingThinking[0].RowColumnKing[j][0], KingOnTable[i].KingThinking[0].RowColumnKing[j][1]]
        ...
        public void MakePenaltyAllCheckMateBranches(AllDraw A, int Order)
        {
            ...
            else
            {
                ...
                for (int i = AllDraw.KingMidle; i < AllDraw.MinisterHigh; i++)
                    for (int j = 0; A.KingOnTable[i] != null && A.KingOnTable[i].KingThinking[0] != null && j < A.KingOnTable[i].KingThinking[0].TableListKing.Count; j++)
                    {
                        try
                        {
                                    ...
                                    {
                                        {
                                            try
                                            {
                                                ...
                                                if (FormRefrigtz.OrderPlate == Order && AStarGreedyi == 1&&ThinkingChess.UsePenaltyRegardMechnisam)
                                                ...
                                                try
                                                {
                                                    ...
                                                    {
                                                        for (int ij = 0; ij < SolderesOnTable[i].SoldierThinking[k].AStarGreedy.Count; ij++)
                                                ...
                                                if (FormRefrigtz.OrderPlate == Order && AStarGreedyi == 1&&ThinkingChess.UsePenaltyRegardMechnisam)
                                                    if ((SolderesOnTable[i].SoldierThinking[k].PenaltyRegardListSolder[j].IsPenaltyAction() != 0 && SolderesOnTable[i].SoldierThinking[k].PenaltyRegardListSolder[j].IsRewardAction() == 1 && AStarGreedyi == 1) || Do == 1 || AA)
                                                    {
                                                        ...
                                                        if (SolderesOnTable[i].SoldierThinking[k].HitNumberSoldier[j] > 0)
                                                            Hit = true;
                                                        //if (Order == 1)
                                                        //SyntaxToWrite = (new ChessRules()).CreateStatistic(TableHuristic, FormRefrigtz.MovmentsNumber, 1, SolderesOnTable[i].SoldierThinking[k].RowColumnSoldier[j][1], SolderesOnTable[i].SoldierThinking[k].RowColumnSoldier[j][0], Hit, SolderesOnTable[i].SoldierThinking[k].HitNumberSoldier[j], ChessRules.BridgeActBrown, false);
                                                        //else
                                                        //SyntaxToWrite = (new ChessRules()).CreateStatistic(TableHuristic, FormRefrigtz.MovmentsNumber, -1, SolderesOnTable[i].SoldierThinking[k].RowColumnSoldier[j][1], SolderesOnTable[i].SoldierThinking[k].RowColumnSoldier[j][0], Hit, SolderesOnTable[i].SoldierThinking[k].HitNumberSoldier[j], ChessRules.BridgeActBrown, false);
                                                        ...
                                                        if (SolderesOnTable[i].Convert)
                                                        {
                                                            ...
                                                            if (SolderesOnTable[i].SoldierThinking[k].HitNumberSoldier[j] > 0)
                                                                Hit = true;
                                                            //if (Order == 1)
                                                            //SyntaxToWrite = (new ChessRules()).CreateStatistic(TableHuristic, FormRefrigtz.MovmentsNumber, 1, SolderesOnTable[i].SoldierThinking[k].RowColumnSoldier[j][1], SolderesOnTable[i].SoldierThinking[k].RowColumnSoldier[j][0], Hit, SolderesOnTable[i].SoldierThinking[k].HitNumberSoldier[j], ChessRules.BridgeActBrown, true);
                                                            //else
                                                            //SyntaxToWrite = (new ChessRules()).CreateStatistic(TableHuristic, FormRefrigtz.MovmentsNumber, -1, SolderesOnTable[i].SoldierThinking[k].RowColumnSoldier[j][1], SolderesOnTable[i].SoldierThinking[k].RowColumnSoldier[j][0], Hit, SolderesOnTable[i].SoldierThinking[k].HitNumberSoldier[j], ChessRules.BridgeActBrown, true);
                                                ...
                                                if (SolderesOnTable[i].SoldierThinking[0].ReturnHuristic(i, j, Order) > Less)
                                                {
                                                    ...
                                                    //if (!ThinkingChess.UsePenaltyRegardMechnisam)
                                                    {
                                                        AB = new ChessRules(1, TableS, Order, SolderesOnTable[i].SoldierThinking[k].Row, SolderesOnTable[i].SoldierThinking[k].Column);
                                    ...
                                    {
                                        {
                                            try
                                            {
                                                ...
                                                try
                                                {
                                                    ...
                                                    if (ThinkingChess.UsePenaltyRegardMechnisam)
                                                    {
                                                        for (int ij = 0; ij < ElephantOnTable[i].ElefantThinking[0].AStarGreedy.Count; ij++)
                                                ...
                                                if (FormRefrigtz.OrderPlate == Order && AStarGreedyi == 1&&ThinkingChess.UsePenaltyRegardMechnisam)
                                                    if ((ElephantOnTable[i].ElefantThinking[k].PenaltyRegardListElefant[j].IsPenaltyAction() != 0 && ElephantOnTable[i].ElefantThinking[k].PenaltyRegardListElefant[j].IsRewardAction() == 1 && AStarGreedyi == 1) || Do == 1 || AA)
                                                    {
                                                        ...
                                                        if (ElephantOnTable[i].ElefantThinking[k].HitNumberElefant[j] > 0)
                                                            Hit = true;
                                                        // if (Order == 1)
                                                        //SyntaxToWrite = (new ChessRules()).CreateStatistic(TableHuristic, FormRefrigtz.MovmentsNumber, 2, ElephantOnTable[i].ElefantThinking[k].RowColumnElefant[j][1], ElephantOnTable[i].ElefantThinking[k].RowColumnElefant[j][0], Hit, ElephantOnTable[i].ElefantThinking[k].HitNumberElefant[j], ChessRules.BridgeActBrown, false);
                                                        // else
                                                        //SyntaxToWrite = (new ChessRules()).CreateStatistic(TableHuristic, FormRefrigtz.MovmentsNumber, -2, ElephantOnTable[i].ElefantThinking[k].RowColumnElefant[j][1], ElephantOnTable[i].ElefantThinking[k].RowColumnElefant[j][0], Hit, ElephantOnTable[i].ElefantThinking[k].HitNumberElefant[j], ChessRules.BridgeActBrown, false);
                                                ...
                                                if (ElephantOnTable[i].ElefantThinking[0].ReturnHuristic(i, j, Order) > Less)
                                                {
                                                    ...
                                                    //if (!ThinkingChess.UsePenaltyRegardMechnisam)
                                                    {
                                                        AB = new ChessRules(2, TableS, Order, -1, -1);
                                                        //If there is kish or kshachamaz Order.
                                                        if (AB.Check(TableS, Order))
                                                        {
                                                            //When Order is Gray.
                                                    ...
                                                    try
                                                    {
                                                        if (AStarGreedyi == 1)
                                                        {
                                                            ...
                                                            if (ElephantOnTable[RW2].ElefantThinking[CL2].HitNumberElefant[Ki2] > 0)
                                                                Hit = true;
                                                            // if (Order == 1)
                                                            //SyntaxToWrite = (new ChessRules()).CreateStatistic(TableHuristic, FormRefrigtz.MovmentsNumber, 2, ElephantOnTable[RW2].ElefantThinking[CL2].RowColumnElefant[Ki2][1], ElephantOnTable[RW2].ElefantThinking[CL2].RowColumnElefant[Ki2][0], Hit, ElephantOnTable[RW2].ElefantThinking[CL2].HitNumberElefant[Ki2], ChessRules.BridgeActBrown, false);
                                                            // else
                                                            //SyntaxToWrite = (new ChessRules()).CreateStatistic(TableHuristic, FormRefrigtz.MovmentsNumber, -2, ElephantOnTable[RW2].ElefantThinking[CL2].RowColumnElefant[Ki2][1], ElephantOnTable[RW2].ElefantThinking[CL2].RowColumnElefant[Ki2][0], Hit, ElephantOnTable[RW2].ElefantThinking[CL2].HitNumberElefant[Ki2], ChessRules.BridgeActBrown, false);
                                    ...
                                    {
                                        {
                                            try
                                            {
                                                ...
                                                try
                                                {
                                                    ...
                                                    if (ThinkingChess.UsePenaltyRegardMechnisam)
                                                    {
                                                        for (int ij = 0; ij < HoursesOnTable[i].HourseThinking[k].AStarGreedy.Count; ij++)
                                                ...
                                                if (FormRefrigtz.OrderPlate == Order && AStarGreedyi == 1&&ThinkingChess.UsePenaltyRegardMechnisam)
                                                    if ((HoursesOnTable[i].HourseThinking[k].PenaltyRegardListHourse[j].IsPenaltyAction() != 0 && HoursesOnTable[i].HourseThinking[k].PenaltyRegardListHourse[j].IsRewardAction() == 1 && AStarGreedyi == 1) || Do == 1 || AA)
                                                    {
                                                        ...
                                                        if (HoursesOnTable[i].HourseThinking[k].HitNumberHourse[j] > 0)
                                                            Hit = true;
                                                        //if (Order == 1)
                                                        //SyntaxToWrite = (new ChessRules()).CreateStatistic(TableHuristic, FormRefrigtz.MovmentsNumber, 3, HoursesOnTable[i].HourseThinking[k].RowColumnHourse[j][1], HoursesOnTable[i].HourseThinking[k].RowColumnHourse[j][0], Hit, HoursesOnTable[i].HourseThinking[k].HitNumberHourse[j], ChessRules.BridgeActBrown, false);
                                                        // else
                                                        //SyntaxToWrite = (new ChessRules()).CreateStatistic(TableHuristic, FormRefrigtz.MovmentsNumber, -3, HoursesOnTable[i].HourseThinking[k].RowColumnHourse[j][1], HoursesOnTable[i].HourseThinking[k].RowColumnHourse[j][0], Hit, HoursesOnTable[i].HourseThinking[k].HitNumberHourse[j], ChessRules.BridgeActBrown, false);
                                                ...
                                                if (HoursesOnTable[i].HourseThinking[0].ReturnHuristic(i, j, Order) > Less)
                                                {
                                                    ...
                                                    int[,] TableSS = HoursesOnTable[i].HourseThinking[k].TableListHourse[j];
                                                    {
                                                        ...
                                                        //if (!ThinkingChess.UsePenaltyRegardMechnisam)
                                                        {
                                                            AB = new ChessRules(3, TableS, Order, HoursesOnTable[i].HourseThinking[k].Row, HoursesOnTable[i].HourseThinking[k].Column);
                                                            //If there is kish or kshachamaz Order.
                                                            if (AB.Check(TableS, Order))
                                                            {
                                                                //When Order is Gray.
                                                    ...
                                                    try
                                                    {
                                                        if (AStarGreedyi == 1)
                                                        {
                                                            ...
                                                            if (HoursesOnTable[RW3].HourseThinking[CL3].HitNumberHourse[Ki3] > 0)
                                                                Hit = true;
                                                            // if (Order == 1)
                                                            //SyntaxToWrite = (new ChessRules()).CreateStatistic(TableHuristic, FormRefrigtz.MovmentsNumber, 3, HoursesOnTable[RW3].HourseThinking[CL3].RowColumnHourse[Ki3][1], HoursesOnTable[RW3].HourseThinking[CL3].RowColumnHourse[Ki3][0], Hit, HoursesOnTable[RW3].HourseThinking[CL3].HitNumberHourse[Ki3], ChessRules.BridgeActBrown, false);
                                                            // else
                                                            //SyntaxToWrite = (new ChessRules()).CreateStatistic(TableHuristic, FormRefrigtz.MovmentsNumber, -3, HoursesOnTable[RW3].HourseThinking[CL3].RowColumnHourse[Ki3][1], HoursesOnTable[RW3].HourseThinking[CL3].RowColumnHourse[Ki3][0], Hit, HoursesOnTable[RW3].HourseThinking[CL3].HitNumberHourse[Ki3], ChessRules.BridgeActBrown, false);
                                    ...
                                    {
                                        {
                                            try
                                            {
                                                ...
                                                try
                                                {
                                                    ...
                                                    if (ThinkingChess.UsePenaltyRegardMechnisam)
                                                    {
                                                        for (int ij = 0; ij < BridgesOnTable[i].BridgeThinking[k].AStarGreedy.Count; ij++)
                                                ...
                                                if (FormRefrigtz.OrderPlate == Order && AStarGreedyi == 1&&ThinkingChess.UsePenaltyRegardMechnisam)
                                                    if ((BridgesOnTable[i].BridgeThinking[k].PenaltyRegardListBridge[j].IsPenaltyAction() != 0 && BridgesOnTable[i].BridgeThinking[k].PenaltyRegardListBridge[j].IsRewardAction() == 1 && AStarGreedyi == 1) || Do == 1 || AA)
                                                    {
                                                        ...
                                                        if (BridgesOnTable[i].BridgeThinking[k].HitNumberBridge[j] > 0)
                                                            Hit = true;
                                                        // if (Order == 1)
                                                        //SyntaxToWrite = (new ChessRules()).CreateStatistic(TableHuristic, FormRefrigtz.MovmentsNumber, 4, BridgesOnTable[i].BridgeThinking[k].RowColumnBridge[j][1], BridgesOnTable[i].BridgeThinking[k].RowColumnBridge[j][0], Hit, BridgesOnTable[i].BridgeThinking[k].HitNumberBridge[j], ChessRules.BridgeActBrown, false);
                                                        // else
                                                        //SyntaxToWrite = (new ChessRules()).CreateStatistic(TableHuristic, FormRefrigtz.MovmentsNumber, -4, BridgesOnTable[i].BridgeThinking[k].RowColumnBridge[j][1], BridgesOnTable[i].BridgeThinking[k].RowColumnBridge[j][0], Hit, BridgesOnTable[i].BridgeThinking[k].HitNumberBridge[j], ChessRules.BridgeActBrown, false);
                                                ...
                                                //When There is No Movments in Such Order Enemy continue.
                                                if (Order != FormRefrigtz.OrderPlate)
                                                    if (BridgesOnTable[i].BridgeThinking[0].ReturnHuristic(i, j, Order) > Less) continue;
                                                //When There is greater Huristic Movments.
                                                if (BridgesOnTable[i].BridgeThinking[0].ReturnHuristic(i, j, Order) > Less)
                                                {
                                                    ...
                                                    //if (!ThinkingChess.UsePenaltyRegardMechnisam)
                                                    {
                                                        AB = new ChessRules(4, TableS, Order, BridgesOnTable[i].BridgeThinking[k].Row, BridgesOnTable[i].BridgeThinking[k].Column);
                                                        //If there is kish or kshachamaz Order.
                                                        if (AB.Check(TableS, Order))
                                                        {
                                                            //When Order is Gray.
                                                    ...
                                                    CL6 = -1;
                                                    Ki6 = -1;
                                                    MaxLess4 = (BridgesOnTable[RW4].BridgeThinking[CL4].ReturnHuristic(RW4, Ki4, Order));
                                                    ...
                                                    try
                                                    {
                                                        if (AStarGreedyi == 1)
                                                        {
                                                            ...
                                                            if (BridgesOnTable[RW4].BridgeThinking[CL4].HitNumberBridge[Ki4] > 0)
                                                                Hit = true;
                                                            //  if (Order == 1)
                                                            //SyntaxToWrite = (new ChessRules()).CreateStatistic(TableHuristic, FormRefrigtz.MovmentsNumber, 4, BridgesOnTable[RW4].BridgeThinking[CL4].RowColumnBridge[Ki4][1], BridgesOnTable[RW4].BridgeThinking[CL4].RowColumnBridge[Ki4][0], Hit, BridgesOnTable[RW4].BridgeThinking[CL4].HitNumberBridge[Ki4], ChessRules.BridgeActBrown, false);
                                                            //  else
                                                            //SyntaxToWrite = (new ChessRules()).CreateStatistic(TableHuristic, FormRefrigtz.MovmentsNumber, -4, BridgesOnTable[RW4].BridgeThinking[CL4].RowColumnBridge[Ki4][1], BridgesOnTable[RW4].BridgeThinking[CL4].RowColumnBridge[Ki4][0], Hit, BridgesOnTable[RW4].BridgeThinking[CL4].HitNumberBridge[Ki4], ChessRules.BridgeActBrown, false);
                                                            ...
                                                            Act = true;
                                                            Less = BridgesOnTable[RW4].BridgeThinking[CL4].ReturnHuristic(RW4, Ki4, Order);
                                    ...
                                    {
                                        {
                                            ...
                                            try
                                            {
                                                ...
                                                if (ThinkingChess.UsePenaltyRegardMechnisam)
                                                {
                                                    for (int ij = 0; ij < MinisterOnTable[i].MinisterThinking[k].AStarGreedy.Count; ij++)
                                            ...
                                            if (FormRefrigtz.OrderPlate == Order && AStarGreedyi == 1&&ThinkingChess.UsePenaltyRegardMechnisam)
                                                if ((MinisterOnTable[i].MinisterThinking[k].PenaltyRegardListMinister[j].IsPenaltyAction() != 0 && MinisterOnTable[i].MinisterThinking[k].PenaltyRegardListMinister[j].IsRewardAction() == 1 && AStarGreedyi == 1) || Do == 1 || AA)
                                                {
                                                    ...
                                                    if (MinisterOnTable[i].MinisterThinking[k].HitNumberMinister[j] > 0)
                                                        Hit = true;
                                                    //if (Order == 1)
                                                    //SyntaxToWrite = (new ChessRules()).CreateStatistic(TableHuristic, FormRefrigtz.MovmentsNumber, 5, MinisterOnTable[i].MinisterThinking[k].RowColumnMinister[j][1], MinisterOnTable[i].MinisterThinking[k].RowColumnMinister[j][0], Hit, MinisterOnTable[i].MinisterThinking[k].HitNumberBridge[j], ChessRules.BridgeActBrown, false);
                                                    else
                                                        //SyntaxToWrite = (new ChessRules()).CreateStatistic(TableHuristic, FormRefrigtz.MovmentsNumber, -5, MinisterOnTable[i].MinisterThinking[k].RowColumnMinister[j][1], MinisterOnTable[i].MinisterThinking[k].RowColumnMinister[j][0], Hit, MinisterOnTable[i].MinisterThinking[k].HitNumberBridge[j], ChessRules.BridgeActBrown, false);
                                            ...
                                            if (MinisterOnTable[i].MinisterThinking[0].ReturnHuristic(i, j, Order) > Less)
                                            {
                                                ...
                                                }
                                                {
                                                    ...
                                                    //if (!ThinkingChess.UsePenaltyRegardMechnisam)
                                                    {
                                                        AB = new ChessRules(5, TableS, Order, MinisterOnTable[i].MinisterThinking[k].Row, MinisterOnTable[i].MinisterThinking[k].Column);
                                                        //If there is kish or kshachamaz Order.
                                                        if (AB.Check(TableS, Order))
                                                        {
                                                            //When Order is Gray.
                                                ...
                                                CL6 = -1;
                                                Ki6 = -1;
                                                MaxLess5 = (MinisterOnTable[i].MinisterThinking[k].ReturnHuristic(i, j, Order));
                                    ...
                                    {
                                        {
                                            try
                                            {
                                                ...
                                                try
                                                {
                                                    ...
                                                    if (ThinkingChess.UsePenaltyRegardMechnisam)
                                                    {
                                                        for (int ij = 0; ij < KingOnTable[i].KingThinking[k].AStarGreedy.Count; ij++)
                                                ...
                                                if (FormRefrigtz.OrderPlate == Order && AStarGreedyi == 1&&ThinkingChess.UsePenaltyRegardMechnisam)
                                                    ...
                                                    {    //Set Table and Huristic Value and Syntax.
                                                        ...
                                                        if (KingOnTable[i].KingThinking[k].HitNumberKing[j] > 0)
                                                            Hit = true;
                                                        //if (Order == 1)
                                                        //SyntaxToWrite = (new ChessRules()).CreateStatistic(TableHuristic, FormRefrigtz.MovmentsNumber, 6, KingOnTable[i].KingThinking[k].RowColumnKing[j][1], KingOnTable[i].KingThinking[k].RowColumnKing[j][0], Hit, KingOnTable[i].KingThinking[k].HitNumberKing[j], ChessRules.BridgeActBrown, false);
                                                        //  else
                                                        //SyntaxToWrite = (new ChessRules()).CreateStatistic(TableHuristic, FormRefrigtz.MovmentsNumber, -6, KingOnTable[i].KingThinking[k].RowColumnKing[j][1], KingOnTable[i].KingThinking[k].RowColumnKing[j][0], Hit, KingOnTable[i].KingThinking[k].HitNumberKing[j], ChessRules.BridgeActBrown, false);
                                                ...
                                                if (KingOnTable[i].KingThinking[0].ReturnHuristic(i, j, Order) > Less)
                                                {
                                                    ...
                                                    //if (!ThinkingChess.UsePenaltyRegardMechnisam)
                                                    {
                                                        AB = new ChessRules(6, TableS, Order, KingOnTable[i].KingThinking[k].Row, KingOnTable[i].KingThinking[k].Column);
                                                        //If there is kish or kshachamaz Order.
                                                        if (AB.Check(TableS, Order))
                                                        {
                                                            //When Order is Gray.
                                                    ...
                                                    CL5 = -1;
                                                    Ki5 = -1;
                                                    MaxLess6 = (KingOnTable[i].KingThinking[k].ReturnHuristic(i, j, Order));
                                                    ...
                                                    try
                                                    {
                                                        if (AStarGreedyi == 1)
                                                        {
                                                            ...
                                                            if (KingOnTable[RW6].KingThinking[CL6].HitNumberKing[Ki6] > 0)
                                                                Hit = true;
                                                            //  if (Order == 1)
                                                            //SyntaxToWrite = (new ChessRules()).CreateStatistic(TableHuristic, FormRefrigtz.MovmentsNumber, 6, KingOnTable[RW6].KingThinking[CL6].RowColumnKing[Ki6][1], KingOnTable[RW6].KingThinking[CL6].RowColumnKing[Ki6][0], Hit, KingOnTable[RW6].KingThinking[CL6].HitNumberKing[Ki6], ChessRules.BridgeActBrown, false);
                                                            //   else
                                                            //SyntaxToWrite = (new ChessRules()).CreateStatistic(TableHuristic, FormRefrigtz.MovmentsNumber, -6, KingOnTable[RW6].KingThinking[CL6].RowColumnKing[Ki6][1], KingOnTable[RW6].KingThinking[CL6].RowColumnKing[Ki6][0], Hit, KingOnTable[RW6].KingThinking[CL6].HitNumberKing[Ki6], ChessRules.BridgeActBrown, false);
                                    ...
                                    for (j = 0; SolderesOnTable[i] != null && SolderesOnTable[i] != null && SolderesOnTable[i].SoldierThinking[k] != null && SolderesOnTable[i].SoldierThinking[k] != null && j < SolderesOnTable[i].SoldierThinking[k].TableListSolder.Count; j++)
                                    {
                                        try
                                        {
                                            ...
                                            if (SolderesOnTable[i].SoldierThinking[0].ReturnHuristic(i, j, Order) > Less)
                                            {
                                                ...
                                                CL6 = -1;
                                                Ki6 = -1;
                                                MaxLess1 = (SolderesOnTable[i].SoldierThinking[k].HuristicListSolder[j][0] + SolderesOnTable[i].SoldierThinking[k].HuristicListSolder[j][1] + SolderesOnTable[i].SoldierThinking[k].HuristicListSolder[j][2] + SolderesOnTable[i].SoldierThinking[k].HuristicListSolder[j][3]);
                                                if (MaxLess1 > MaxLess2)
                                                    MaxLess2 = -1;
                                                if (MaxLess1 > MaxLess3)
                                                    MaxLess3 = -1;
                                    ...
                                    for (j = 0; ElephantOnTable[i] != null && ElephantOnTable[i] != null && ElephantOnTable[i].ElefantThinking[k] != null && ElephantOnTable[i].ElefantThinking[k] != null && j < ElephantOnTable[i].ElefantThinking[k].TableListElefant.Count; j++)
                                    {
                                        try
                                        {
                                            ...
                                            try
                                            {
                                                ...
                                                if (ThinkingChess.UsePenaltyRegardMechnisam)
                                                {
                                                    for (int ij = 0; ij < ElephantOnTable[i].ElefantThinking[k].AStarGreedy.Count; ij++)
                                                        ElephantOnTable[i].ElefantThinking[k].AStarGreedy[ij].IsPenaltyRegardCheckMateAtBranch(Order, ref Do, ElephantOnTable[i].ElefantThinking[k].AStarGreedy[ij]);
                                                    Order = COrder;
                                                    ChessRules.CurrentOrder = CDummy;
                                                    ToCheckMate = -1; ForCheckMate = -1; AA = IsToCheckMateHasLessDeeperThanForCheckMate(this, Order, ref ToCheckMate, ref ForCheckMate, 0); if (Do == -1)
                                            ...
                                            if (ElephantOnTable[i].ElefantThinking[0].ReturnHuristic(i, j, Order) > Less)
                                            {
                                                ...
                                                //if (!ThinkingChess.UsePenaltyRegardMechnisam)
                                                {
                                                    AB = new ChessRules(2, TableS, Order, ElephantOnTable[i].ElefantThinking[k].Row, ElephantOnTable[i].ElefantThinking[k].Column);
                                                    //If there is kish or kshachamaz Order.
                                                    if (AB.Check(TableS, Order))
                                                    {
                                                        //When Order is Gray.
                                    ...
                                    for (j = 0; HoursesOnTable[i] != null && HoursesOnTable[i] != null && HoursesOnTable[i].HourseThinking[k] != null && HoursesOnTable[i].HourseThinking[k] != null && j < HoursesOnTable[i].HourseThinking[k].TableListHourse.Count; j++)
                                    {
                                        try
                                        {
                                            ...
                                            if (HoursesOnTable[i].HourseThinking[0].ReturnHuristic(i, j, Order) > Less)
                                            {
                                                ...
                                                CL6 = -1;
                                                Ki6 = -1;
                                                MaxLess3 = (HoursesOnTable[RW3].HourseThinking[CL3].HuristicListHourse[Ki3][0] + HoursesOnTable[RW3].HourseThinking[CL3].HuristicListHourse[Ki3][1] + HoursesOnTable[RW3].HourseThinking[CL3].HuristicListHourse[Ki3][2] + HoursesOnTable[RW3].HourseThinking[CL3].HuristicListHourse[Ki3][3]); ;
                                                if (MaxLess3 > MaxLess1)
                                                    MaxLess1 = -1;
                                                if (MaxLess3 > MaxLess2)
                                                    MaxLess2 = -1;
                                            ...
                                            //retrive table of current huristic.
                                            {
                                                ...
                                                if (AStarGreedyi == 1)
                                                {
                                                    ...
                                                    if (MinisterOnTable[i].MinisterThinking[k].HitNumberMinister[j] > 0)
                                                        Hit = true;
                                                    //  if (Order == 1)
                                                    //SyntaxToWrite = (new ChessRules()).CreateStatistic(TableHuristic, FormRefrigtz.MovmentsNumber, 5, MinisterOnTable[i].MinisterThinking[k].RowColumnMinister[j][1], MinisterOnTable[i].MinisterThinking[k].RowColumnMinister[j][0], Hit, MinisterOnTable[i].MinisterThinking[k].HitNumberMinister[j], ChessRules.BridgeActBrown, false);
                                                    // else
                                                    //SyntaxToWrite = (new ChessRules()).CreateStatistic(TableHuristic, FormRefrigtz.MovmentsNumber, -5, MinisterOnTable[i].MinisterThinking[k].RowColumnMinister[j][1], MinisterOnTable[i].MinisterThinking[k].RowColumnMinister[j][0], Hit, MinisterOnTable[i].MinisterThinking[k].HitNumberMinister[j], ChessRules.BridgeActBrown, false);
                        ...
                        for (j = 0; SolderesOnTable[i] != null && SolderesOnTable[i].SoldierThinking[k] != null && j < SolderesOnTable[i].SoldierThinking[k].TableListSolder.Count; j++)
                        {
                            try
                            {
                                ...
                                if (SolderesOnTable[i].SoldierThinking[0].ReturnHuristic(i, j, Order) > Less)
                                {
                                    ...
                                    {
                                        AA = new ChessRules(1, TableS, Order, SolderesOnTable[i].SoldierThinking[k].Row, SolderesOnTable[i].SoldierThinking[k].Column);
                                    ...
                                    if (Order == 1)//If Order is Gray.
                                    {
                                        ...
                                        if (AA.CheckGrayObjectDangour && !AStarGreadyFirstSearch)
                                        {
                                            ...
                                            {
                                                AA = new ChessRules(1, Table, FormRefrigtz.OrderPlate, -1, -1);
                        ...
                        for (j = 0; ElephantOnTable[i] != null && ElephantOnTable[i].ElefantThinking[k] != null && j < ElephantOnTable[i].ElefantThinking[k].TableListElefant.Count; j++)
                        {
                            try
                            {
                                ...
                                if (ElephantOnTable[i].ElefantThinking[0].ReturnHuristic(i, j, Order) > Less)
                                {
                                    ...
                                    int[,] TableS = ElephantOnTable[i].ElefantThinking[k].TableListElefant[j];
                                    {
                                        AA = new ChessRules(2, TableS, Order, ElephantOnTable[i].ElefantThinking[k].Row, ElephantOnTable[i].ElefantThinking[k].Column);
                                        //Achamaz Check CheckMate of Current Table.
                                        if (AA.ObjectDangourKingMove(Order, TableS, false) && !NoTableFound)
                                        {
                                            //If Order is Gray.
                                    ...
                                    if (Order == 1)//If Order is Gray.
                                    {
                                        ...
                                        if (AA.CheckGrayObjectDangour && !AStarGreadyFirstSearch)
                                        {
                                            ...
                                            AA = new ChessRules(2, Table, FormRefrigtz.OrderPlate, -1, -1);
                                            AA.Check(Table, FormRefrigtz.OrderPlate);
                                            if (AA.CheckGray)
                                            {
                                                Table = null;
                        ...
                        for (j = 0; HoursesOnTable[i] != null && HoursesOnTable[i].HourseThinking[k] != null && j < HoursesOnTable[i].HourseThinking[k].TableListHourse.Count; j++)
                        {
                            try
                            {
                                ...
                                if (HoursesOnTable[i].HourseThinking[0].ReturnHuristic(i, j, Order) > Less)
                                {
                                    ...
                                    {
                                        {
                                            AA = new ChessRules(3, TableS, Order, HoursesOnTable[i].HourseThinking[k].Row, HoursesOnTable[i].HourseThinking[k].Column);
                                            //Achamaz Check CheckMate of Current Table.
                                            if (AA.ObjectDangourKingMove(Order, TableS, false) && !NoTableFound)
                                            {
                                                //If Order is Gray.
                                    ...
                                    if (Order == 1)//If Order is Gray.
                                    {
                                        ...
                                        if (AA.CheckGrayObjectDangour && !AStarGreadyFirstSearch)
                                        {
                                            ...
                                            if (Table == null)
                                                continue;
                                            AA = new ChessRules(3, Table, FormRefrigtz.OrderPlate, -1, -1);
                                            AA.Check(Table, FormRefrigtz.OrderPlate);
                                            if (AA.CheckGray)
                                            {
                                                Table = null;
                        ...
                        for (j = 0; BridgesOnTable[i] != null && BridgesOnTable[i].BridgeThinking[k] != null && j < BridgesOnTable[i].BridgeThinking[k].TableListBridge.Count; j++)
                        {
                            try
                            {
                                ...
                                if (BridgesOnTable[i].BridgeThinking[0].ReturnHuristic(i, j, Order) > Less)
                                {
                                    ...
                                    int[,] TableS = BridgesOnTable[i].BridgeThinking[k].TableListBridge[j];
                                    {
                                        AA = new ChessRules(4, TableS, Order, BridgesOnTable[i].BridgeThinking[k].Row, BridgesOnTable[i].BridgeThinking[k].Column);
                                        //Achamaz Check CheckMate of Current Table.
                                        if (AA.ObjectDangourKingMove(Order, TableS, false) && !NoTableFound)
                                        {
                                            //If Order is Gray.
                                    ...
                                    if (Order == 1)//If Order is Gray.
                                    {
                                        ...
                                        if (AA.CheckGrayObjectDangour && !AStarGreadyFirstSearch)
                                        {
                                            ...
                                            if (Table == null)
                                                continue;
                                            AA = new ChessRules(4, Table, FormRefrigtz.OrderPlate, -1, -1);
                                            AA.Check(Table, FormRefrigtz.OrderPlate);
                                            if (AA.CheckGray)
                                            {
                                                Table = null;
                        ...
                        for (j = 0; MinisterOnTable[i] != null && MinisterOnTable[i].MinisterThinking[k] != null && j < MinisterOnTable[i].MinisterThinking[k].TableListMinister.Count; j++)
                        {
                            try
                            {
                                ...
                                if (MinisterOnTable[i].MinisterThinking[k].ReturnHuristic(i, j, Order) > Less)
                                {
                                    ...
                                    {
                                        {
                                            AA = new ChessRules(5, TableS, Order, MinisterOnTable[i].MinisterThinking[k].Row, MinisterOnTable[i].MinisterThinking[k].Column);
                                            //Achamaz Check CheckMate of Current Table.
                                            if (AA.ObjectDangourKingMove(Order, TableS, false) && !NoTableFound)
                                            {
                                                //If Order is Gray.
                                    ...
                                    if (Order == 1)//If Order is Gray.
                                    {
                                        ...
                                        if (AA.CheckGrayObjectDangour && !AStarGreadyFirstSearch)
                                        {
                                            ...
                                            if (Table == null)
                                                continue;
                                            AA = new ChessRules(5, Table, FormRefrigtz.OrderPlate, -1, -1);
                                            AA.Check(Table, FormRefrigtz.OrderPlate);
                                            if (AA.CheckGray)
                                            {
                                                Table = null;
                        ...
                        for (j = 0; KingOnTable[i] != null && KingOnTable[i].KingThinking[k] != null && j < KingOnTable[i].KingThinking[k].TableListKing.Count; j++)
                        {
                            try
                            {
                                ...
                                if (KingOnTable[i].KingThinking[0].ReturnHuristic(i, j, Order) > Less)
                                {
                                    ...
                                    int[,] TableS = KingOnTable[i].KingThinking[k].TableListKing[j];
                                    {
                                        AA = new ChessRules(6, TableS, Order, KingOnTable[i].KingThinking[k].Row, KingOnTable[i].KingThinking[k].Column);
                                        //Achamaz Check CheckMate of Current Table.
                                        if (AA.ObjectDangourKingMove(Order, TableS, false) && !NoTableFound)
                                        {
                                            //If Order is Gray.
                                    ...
                                    if (Order == 1)//If Order is Gray.
                                    {
                                        ...
                                        if (AA.CheckGrayObjectDangour && !AStarGreadyFirstSearch)
                                        {
                                            ...
                                            if (Table == null)
                                                continue;
                                            AA = new ChessRules(6, Table, FormRefrigtz.OrderPlate, -1, -1);
                                            AA.Check(Table, FormRefrigtz.OrderPlate);
                                            if (AA.CheckGray)
                                            {
                                                Table = null;
        ...
        public void InitiateGenetic(int ii, int jj, Color a, int[,] Table, int Order, bool TB)
        {
            ...
            (new ChessRules(1, Table, Order, -1, -1)).CheckMate(Table, Order);
        ...
        public AllDraw InitiateAStarGreedyt(int iAStarGreedy, int ii, int jj, Color a, int[,] Tab, int Order, bool TB//, ref Refrigtz.Timer timer, ref Refrigtz.Timer TimerColor, ref double Less
            )
        {
            ...
            ChessRules AAA = new ChessRules(Order);
            //if (AAA.CheckMate(Table, Order)) 
            //  if (ChessRules.CheckMateGray || ChessRules.CheckMateBrown)                
            //       return null;                
            //
            //if (ThinkingChess.FoundFirstMating)
            //   return null;

            if (iAStarGreedy > MaxAStarGreedy)
                return null;

            //if (ThinkingChess.MovementsAStarGreedyHuristicFound && iAStarGreedy != 1)
            //    return null;
                ...
                a = Color.Brown;
            {
                    ...
                    if (Order == 1)
                    {
                        ...
                        for (i = 0; i < AllDraw.SodierMidle; i++)
                        {
                            try
                            {
                                ...
                                SolderesOnTable[i] = new DrawSoldier(ii, jj, a, Table, Order, false, i);;
                                ...
                                if (SolderesOnTable[i].SoldierThinking[0].TableListSolder.Count == 0)
                                {
                                    ...
                                    for (j = 0; j < AllDraw.SodierMovments; j++)
                                    {
                                        ...
                                        SolderesOnTable[i].SoldierThinking[0].AStarGreedy.Add(new AllDraw(ref THIS));
                                        // SolderesOnTable[i].SoldierThinking[0].AStarGreedy[SolderesOnTable[i].SoldierThinking[0].AStarGreedy.Count - 1].SolderesOnTable[i] = new DrawSoldier(SolderesOnTable[i].Row, SolderesOnTable[i].Column, SolderesOnTable[i].color, SolderesOnTable[i].Table, SolderesOnTable[i].Order, false, SolderesOnTable[i].Current);
                                        ...
                                        if (!FormRefrigtz.Blitz)
                                            SolderesOnTable[i].SoldierThinking[0].AStarGreedy[SolderesOnTable[i].SoldierThinking[0].AStarGreedy.Count - 1].InitiateAStarGreedyt(iAStarGreedy, ii, jj, a, Table, Order, false);
                        ...
                        for (i = 0; i < AllDraw.ElefantMidle; i++)
                        {
                            try
                            {
                                ...
                                ElephantOnTable[i] = new DrawElefant(ii, jj, a, Table, Order, false, i);;
                                ...
                                if (ElephantOnTable[i].ElefantThinking[0].TableListElefant.Count == 0)
                                {
                                    ...
                                    for (j = 0; j < AllDraw.ElefantMovments; j++)
                                    {
                                        ...
                                        Order *= -1;
                                        ChessRules.CurrentOrder *= -1;
                                        ElephantOnTable[i].ElefantThinking[0].AStarGreedy.Add(new AllDraw(ref THIS));
                                        //ElephantOnTable[i].ElefantThinking[0].AStarGreedy[ElephantOnTable[i].ElefantThinking[0].AStarGreedy.Count - 1].ElephantOnTable[i] = new DrawElefant(ElephantOnTable[i].Row, ElephantOnTable[i].Column, ElephantOnTable[i].color, ElephantOnTable[i].Table, ElephantOnTable[i].Order, false, ElephantOnTable[i].Current);
                                        this.Clone(ElephantOnTable[i].ElefantThinking[0].AStarGreedy[ElephantOnTable[i].ElefantThinking[0].AStarGreedy.Count - 1]);
                                        //Dummy = this.CopyRemeiningItems(Dummy, Order * -1);
                                        if (!FormRefrigtz.Blitz)
                                            ElephantOnTable[i].ElefantThinking[0].AStarGreedy[ElephantOnTable[i].ElefantThinking[0].AStarGreedy.Count - 1].InitiateAStarGreedyt(iAStarGreedy, ii, jj, a, Table, Order, false);
                        ...
                        for (i = 0; i < AllDraw.HourseMidle; i++)
                        {
                            try
                            {
                                ...
                                HoursesOnTable[i] = new DrawHourse(ii, jj, a, Table, Order, false, i);;
                                ...
                                if (HoursesOnTable[i].HourseThinking[0].TableListHourse.Count == 0)
                                {
                                    ...
                                    for (j = 0; j < AllDraw.HourseMovments; j++)
                                    {
                                        ...
                                        Order *= -1;
                                        ChessRules.CurrentOrder *= -1;
                                        HoursesOnTable[i].HourseThinking[0].AStarGreedy.Add(new AllDraw(ref THIS));
                                        //HoursesOnTable[i].HourseThinking[0].AStarGreedy[HoursesOnTable[i].HourseThinking[0].AStarGreedy.Count - 1].HoursesOnTable[i] = new DrawHourse(HoursesOnTable[i].Row, HoursesOnTable[i].Column, HoursesOnTable[i].color, HoursesOnTable[i].Table, HoursesOnTable[i].Order, false, HoursesOnTable[i].Current);
                                        this.Clone(HoursesOnTable[i].HourseThinking[0].AStarGreedy[HoursesOnTable[i].HourseThinking[0].AStarGreedy.Count - 1]);
                                        //Dummy = this.CopyRemeiningItems(Dummy, Order * -1);
                                        if (!FormRefrigtz.Blitz)
                                            HoursesOnTable[i].HourseThinking[0].AStarGreedy[HoursesOnTable[i].HourseThinking[0].AStarGreedy.Count - 1].InitiateAStarGreedyt(iAStarGreedy, ii, jj, a, Table, Order, false);
                                        //Global Order.
                                        Order = DummyOrder;
                                        ChessRules.CurrentOrder = DummyCurrentOrder;
                        ...
                        for (i = 0; i < AllDraw.BridgeMidle; i++)
                        {
                            try
                            {
                                ...
                                BridgesOnTable[i] = new DrawBridge(ii, jj, a, Table, Order, false, i);;
                                ...
                                if (BridgesOnTable[i].BridgeThinking[0].TableListBridge.Count == 0)
                                {
                                    ...
                                    for (j = 0; j < AllDraw.BridgeMovments; j++)
                                    {
                                        ...
                                        Order *= -1;
                                        ChessRules.CurrentOrder *= -1;
                                        BridgesOnTable[i].BridgeThinking[0].AStarGreedy.Add(new AllDraw(ref THIS));
                                        //BridgesOnTable[i].BridgeThinking[0].AStarGreedy[BridgesOnTable[i].BridgeThinking[0].AStarGreedy.Count - 1].BridgesOnTable[i] = new DrawBridge(BridgesOnTable[i].Row, BridgesOnTable[i].Column, BridgesOnTable[i].color, BridgesOnTable[i].Table, BridgesOnTable[i].Order, false, BridgesOnTable[i].Current);
                                        this.Clone(BridgesOnTable[i].BridgeThinking[0].AStarGreedy[BridgesOnTable[i].BridgeThinking[0].AStarGreedy.Count - 1]);
                                        //Dummy = this.CopyRemeiningItems(Dummy, Order * -1);
                                        if (!FormRefrigtz.Blitz)
                                            BridgesOnTable[i].BridgeThinking[0].AStarGreedy[BridgesOnTable[i].BridgeThinking[0].AStarGreedy.Count - 1].InitiateAStarGreedyt(iAStarGreedy, ii, jj, a, Table, Order, false);
                                        Order = DummyOrder;
                                        ChessRules.CurrentOrder = DummyCurrentOrder;
                        ...
                        try
                        {
                            ...
                            for (i = 0; i < AllDraw.MinisterMidle; i++)
                            {
                                ...
                                MinisterOnTable[i] = new DrawMinister(ii, jj, a, Table, Order, false, i);;
                                ...
                                if (MinisterOnTable[i].MinisterThinking[0].TableListMinister.Count == 0)
                                {
                                    ...
                                    for (j = 0; j < AllDraw.MinisterMovments; j++)
                                    {
                                        ...
                                        MinisterOnTable[i].MinisterThinking[0].AStarGreedy.Add(new AllDraw(ref THIS));
                                        //MinisterOnTable[i].MinisterThinking[0].AStarGreedy[MinisterOnTable[i].MinisterThinking[0].AStarGreedy.Count - 1].MinisterOnTable[i] = new DrawMinister(MinisterOnTable[i].Row, MinisterOnTable[i].Column, MinisterOnTable[i].color, MinisterOnTable[i].Table, MinisterOnTable[i].Order, false, MinisterOnTable[i].Current);
                                        this.Clone(MinisterOnTable[i].MinisterThinking[0].AStarGreedy[MinisterOnTable[i].MinisterThinking[0].AStarGreedy.Count - 1]);
                                        //Dummy = this.CopyRemeiningItems(Dummy, Order * -1);
                                        if (!FormRefrigtz.Blitz)
                                            MinisterOnTable[i].MinisterThinking[0].AStarGreedy[MinisterOnTable[i].MinisterThinking[0].AStarGreedy.Count - 1].InitiateAStarGreedyt(iAStarGreedy, ii, jj, a, Table, Order, false);
                                        //Initiate of Global Varibales By Local Varibales.
                                        Order = DummyOrder;
                                        ChessRules.CurrentOrder = DummyCurrentOrder;
                        ...
                        for (i = 0; i < AllDraw.KingMidle; i++)
                        {
                            try
                            {
                                ...
                                jj = (int)KingOnTable[i].Column;
                                //Construction of Gray King Thinking Objects.
                                KingOnTable[i] = new DrawKing(ii, jj, a, Table, Order, false, i);;
                                ...
                                if (KingOnTable[i].KingThinking[0].TableListKing.Count == 0)
                                {
                                    ...
                                    for (j = 0; j < AllDraw.KingMovments; j++)
                                    {
                                        ...
                                        Order *= -1;
                                        ChessRules.CurrentOrder *= -1;
                                        KingOnTable[i].KingThinking[0].AStarGreedy.Add(new AllDraw(ref THIS));
                                        //KingOnTable[i].KingThinking[0].AStarGreedy[KingOnTable[i].KingThinking[0].AStarGreedy.Count - 1].KingOnTable[i] = new DrawKing(KingOnTable[i].Row, KingOnTable[i].Column, KingOnTable[i].color, KingOnTable[i].Table, KingOnTable[i].Order, false, KingOnTable[i].Current);
                                        ...
                                        if (!FormRefrigtz.Blitz)
                                            KingOnTable[i].KingThinking[0].AStarGreedy[KingOnTable[i].KingThinking[0].AStarGreedy.Count - 1].InitiateAStarGreedyt(iAStarGreedy, ii, jj, a, Table, Order, false);
                    ...
                    FormRefrigtz.Blitz)
                {
                    ...
                    BlitzGameThinkingTree(Order, iAStarGreedy, ik, j, ref ThA);
                ...
                {
                    FullGameThinkingTree(Order, iAStarGreedy, ii, jj, ik, j, ref ThA);
                }
            }
            //if (FormRefrigtz.Blitz)
            try
        ...
        void BlitzGameThinkingTree(int Order, int iAStarGreedy,int ik,int j,ref List<Task> ThA)
        {             //Initiatye Variables.
            int DummyOrder = Order;
            int DummyCurrentOrder = ChessRules.CurrentOrder;
            ...
            if (Order == 1)
            {
                Index[0] = -1;
                //Soldeir
                for (ik = AllDraw.SodierMidle; ik < AllDraw.SodierHigh; ik++)
                    try
                    {
                ...
                Index[1] = -1;
                //Elephant
                for (ik = AllDraw.ElefantMidle; ik < AllDraw.ElefantHigh; ik++)
                    try
                    {
                ...
                Index[2] = -1;
                //Hourse.
                for (ik = AllDraw.HourseMidle; ik < AllDraw.HourseHight; ik++)
                    try
                    {
                ...
                Index[3] = -1;
                //Bridge.
                for (ik = AllDraw.BridgeMidle; ik < AllDraw.BridgeHigh; ik++)
                    try
                    {
                ...
                Index[4] = -1;
                //Minister.
                for (ik = AllDraw.MinisterMidle; ik < AllDraw.MinisterHigh; ik++)
                    try
                    {
                ...
                Index[5] = -1;
                //King.
                for (ik = AllDraw.KingMidle; ik < AllDraw.KingHigh; ik++)
                    try
                    {
                ...
                if (JI != -1)
                {
                    ...
                    if (Index[0] != -1)
                    {
                        if (SolderesOnTable[Index[0]].SoldierThinking[0].AStarGreedy.Count == 0)
                            SolderesOnTable[Index[0]].SoldierThinking[0].AStarGreedy.Add(new AllDraw(ref THIS));
                        ...
                        Task array = new Task(() => SolderesOnTable[Index[0]].SoldierThinking[0].AStarGreedy[SolderesOnTable[Index[0]].SoldierThinking[0].AStarGreedy.Count - 1].InitiateAStarGreedyt(iAStarGreedy, SolderesOnTable[Index[0]].SoldierThinking[0].RowColumnSoldier[jIndex[0]][0], SolderesOnTable[Index[0]].SoldierThinking[0].RowColumnSoldier[jIndex[0]][1], a, SolderesOnTable[Index[0]].SoldierThinking[0].TableListSolder[jIndex[0]], Order, false));
                    ...
                    if (Index[1] != -1)
                    {
                        if (ElephantOnTable[Index[1]].ElefantThinking[0].AStarGreedy.Count == 0)
                            ElephantOnTable[Index[1]].ElefantThinking[0].AStarGreedy.Add(new AllDraw(ref THIS));
                    ...
                    if (Index[2] != -1)
                    {
                        if (HoursesOnTable[Index[2]].HourseThinking[0].AStarGreedy.Count == 0)
                            HoursesOnTable[Index[2]].HourseThinking[0].AStarGreedy.Add(new AllDraw(ref THIS));
                    ...
                    if (Index[3] != -1)
                    {
                        if (BridgesOnTable[Index[3]].BridgeThinking[0].AStarGreedy.Count == 0)
                            BridgesOnTable[Index[3]].BridgeThinking[0].AStarGreedy.Add(new AllDraw(ref THIS));
                        ...
                        Task array = new Task(() => BridgesOnTable[Index[3]].BridgeThinking[0].AStarGreedy[BridgesOnTable[Index[3]].BridgeThinking[0].AStarGreedy.Count - 1].InitiateAStarGreedyt(iAStarGreedy, BridgesOnTable[Index[3]].BridgeThinking[0].RowColumnBridge[jIndex[3]][0], BridgesOnTable[Index[3]].BridgeThinking[0].RowColumnBridge[jIndex[3]][1], a, BridgesOnTable[Index[3]].BridgeThinking[0].TableListBridge[jIndex[3]], Order, false));
                        Object ttttt = new Object(); lock (ttttt) { ThA.Add(array); }
                    ...
                    if (Index[4] != -1)
                    {
                        if (MinisterOnTable[Index[4]].MinisterThinking[0].AStarGreedy.Count == 0)
                            MinisterOnTable[Index[4]].MinisterThinking[0].AStarGreedy.Add(new AllDraw(ref THIS));
                    ...
                    if (Index[5] != -1)
                    {
                        if (KingOnTable[Index[5]].KingThinking[0].AStarGreedy.Count == 0)
                            KingOnTable[Index[5]].KingThinking[0].AStarGreedy.Add(new AllDraw(ref THIS));
                        ...
                        Task array = new Task(() => KingOnTable[Index[5]].KingThinking[0].AStarGreedy[KingOnTable[Index[5]].KingThinking[0].AStarGreedy.Count - 1].InitiateAStarGreedyt(iAStarGreedy, KingOnTable[Index[5]].KingThinking[0].RowColumnKing[jIndex[5]][0], KingOnTable[Index[5]].KingThinking[0].RowColumnKing[jIndex[5]][1], a, KingOnTable[Index[5]].KingThinking[0].TableListKing[jIndex[5]], Order, false));
                        Object ttttt = new Object(); lock (ttttt) { ThA.Add(array); }
            ...
            {
                Index[0] = -1;
                for (ik = 0; ik < AllDraw.SodierMidle; ik++)
                    try
                    {
                ...
                Index[1] = -1;
                //Elephant
                for (ik = 0; ik < AllDraw.ElefantMidle; ik++)
                    try
                    {
                        for (j = 0; j < ElephantOnTable[ik].ElefantThinking[0].HuristicListElefant.Count; j++)
                        {
                ...
                Index[2] = -1;
                //Hourse.
                for (ik = 0; ik < AllDraw.HourseMidle; ik++)
                    try
                    {
                        for (j = 0; j < HoursesOnTable[ik].HourseThinking[0].HuristicListHourse.Count; j++)
                        {
                ...
                Index[3] = -1;
                //Bridges.
                for (ik = 0; ik < AllDraw.BridgeMidle; ik++)
                    try
                    {
                        for (j = 0; j < BridgesOnTable[ik].BridgeThinking[0].HuristicListBridge.Count; j++)
                        {
                ...
                Index[4] = -1;
                //Minister.
                for (ik = 0; ik < AllDraw.MinisterMidle; ik++)
                    try
                    {
                        for (j = 0; j < MinisterOnTable[ik].MinisterThinking[0].HuristicListMinister.Count; j++)
                        {
                ...
                Index[5] = -1;
                //King.
                for (ik = 0; ik < AllDraw.KingMidle; ik++)
                    try
                    {
                        for (j = 0; j < KingOnTable[ik].KingThinking[0].HuristicListKing.Count; j++)
                        {
        ...
        void FullGameThinkingTree(int Order, int iAStarGreedy,int ii,int jj,int ik,int j,ref List<Task> ThA)
        {                     //Initiatye Variables.
            int DummyOrder = Order;
            int DummyCurrentOrder = ChessRules.CurrentOrder;
                            ...
                            for (j = 0; j < SolderesOnTable[ik].SoldierThinking[0].TableListSolder.Count; j++)
                            {
                                if (SolderesOnTable[ik].SoldierThinking[0].PenaltyRegardListSolder[j].IsPenaltyAction() != 0)
                                {
                                    ...
                                    // if (Index[0] != -1)
                                    {
                                        ...
                                        SolderesOnTable[ik].SoldierThinking[0].AStarGreedy.Add(new AllDraw(ref THIS));
                                        ...
                                        if (SolderesOnTable[ik].SoldierThinking[0].AStarGreedy.Count > 0)
                                        {
                                            Task array = new Task(() => SolderesOnTable[ik].SoldierThinking[0].AStarGreedy[SolderesOnTable[ik].SoldierThinking[0].AStarGreedy.Count - 1].InitiateAStarGreedyt(iAStarGreedy, ii, jj, a, CloneATable(SolderesOnTable[ik].SoldierThinking[0].TableListSolder[j]), Order, false));
                                            Object ttttt = new Object(); lock (ttttt) { ThA.Add(array); }
                                            //array.Name = "S" + i.ToString();
                                            array.Start();
                                        }
                            ...
                            for (j = 0; j < ElephantOnTable[ik].ElefantThinking[0].TableListElefant.Count; j++)
                            {
                                if (ElephantOnTable[ik].ElefantThinking[0].PenaltyRegardListElefant[j].IsPenaltyAction() != 0)
                                {
                                    //if (Index[1] != -1)
                                    {
                                        ...
                                        ElephantOnTable[ik].ElefantThinking[0].AStarGreedy.Add(new AllDraw(ref THIS));
                                        ...
                                        if (ElephantOnTable[ik].ElefantThinking[0].AStarGreedy.Count > 0)
                                        {
                                            Task array = new Task(() => ElephantOnTable[ik].ElefantThinking[0].AStarGreedy[ElephantOnTable[ik].ElefantThinking[0].AStarGreedy.Count - 1].InitiateAStarGreedyt(iAStarGreedy, ii, jj, a, CloneATable(ElephantOnTable[ik].ElefantThinking[0].TableListElefant[j]), Order, false));
                                            Object ttttt = new Object(); lock (ttttt) { ThA.Add(array); }
                                            //array.Name = "E" + i.ToString();
                                            array.Start();
                                        }
                            ...
                            for (j = 0; j < HoursesOnTable[ik].HourseThinking[0].TableListHourse.Count; j++)
                            {
                                ...
                                if (HoursesOnTable[ik].HourseThinking[0].PenaltyRegardListHourse[j].IsPenaltyAction() != 0)
                                {
                                    //if (Index[2] != -1)
                                    {
                                        ...
                                        HoursesOnTable[ik].HourseThinking[0].AStarGreedy.Add(new AllDraw(ref THIS));
                                        ...
                                        if (HoursesOnTable[ik].HourseThinking[0].AStarGreedy.Count > 0)
                                        {
                                            Task array = new Task(() => HoursesOnTable[ik].HourseThinking[0].AStarGreedy[HoursesOnTable[ik].HourseThinking[0].AStarGreedy.Count - 1].InitiateAStarGreedyt(iAStarGreedy, ii, jj, a, CloneATable(HoursesOnTable[ik].HourseThinking[0].TableListHourse[j]), Order, false));
                                            Object ttttt = new Object(); lock (ttttt) { ThA.Add(array); }
                                            //array.Name = "H" + i.ToString();
                                            array.Start();
                                        }
                            ...
                            for (j = 0; j < BridgesOnTable[ik].BridgeThinking[0].TableListBridge.Count; j++)
                            {
                                if (BridgesOnTable[ik].BridgeThinking[0].PenaltyRegardListBridge[j].IsPenaltyAction() != 0)
                                {
                                    ...
                                    //if (Index[3] != -1)
                                    {
                                        ...
                                        BridgesOnTable[ik].BridgeThinking[0].AStarGreedy.Add(new AllDraw(ref THIS));
                                        ...
                                        if (BridgesOnTable[ik].BridgeThinking[0].AStarGreedy.Count > 0)
                                        {
                                            Task array = new Task(() => BridgesOnTable[ik].BridgeThinking[0].AStarGreedy[BridgesOnTable[ik].BridgeThinking[0].AStarGreedy.Count - 1].InitiateAStarGreedyt(iAStarGreedy, ii, jj, a, CloneATable(BridgesOnTable[ik].BridgeThinking[0].TableListBridge[j]), Order, false));
                                            Object ttttt = new Object(); lock (ttttt) { ThA.Add(array); }
                                            //array.Name = "B" + i.ToString();
                                            array.Start();
                                        }
                            ...
                            for (j = 0; j < MinisterOnTable[ik].MinisterThinking[0].TableListMinister.Count; j++)
                            {
                                ...
                                if (MinisterOnTable[ik].MinisterThinking[0].PenaltyRegardListMinister[j].IsPenaltyAction() != 0)
                                {
                                    //if (Index[4] != -1)
                                    {
                                        ...
                                        MinisterOnTable[ik].MinisterThinking[0].AStarGreedy.Add(new AllDraw(ref THIS));
                                        ...
                                        if (MinisterOnTable[ik].MinisterThinking[0].AStarGreedy.Count > 0)
                                        {
                                            Task array = new Task(() => MinisterOnTable[ik].MinisterThinking[0].AStarGreedy[MinisterOnTable[ik].MinisterThinking[0].AStarGreedy.Count - 1].InitiateAStarGreedyt(iAStarGreedy, ii, jj, a, CloneATable(MinisterOnTable[ik].MinisterThinking[0].TableListMinister[j]), Order, false));
                                            Object ttttt = new Object(); lock (ttttt) { ThA.Add(array); }
                                            //array.Name = "M" + i.ToString();
                                            array.Start();
                                        }
                    ...
                    {
                        {
                            ...
                            for (j = 0; j < KingOnTable[ik].KingThinking[0].TableListKing.Count; j++)
                            {
                                if (KingOnTable[ik].KingThinking[0].PenaltyRegardListKing[j].IsPenaltyAction() != 0)
                                {
                                    ...
                                    KingOnTable[ik].KingThinking[0].AStarGreedy.Add(new AllDraw(ref THIS));
                                    ...
                                    if (KingOnTable[ik].KingThinking[0].AStarGreedy.Count > 0)
                                    {
                                        Task array = new Task(() => KingOnTable[ik].KingThinking[0].AStarGreedy[KingOnTable[ik].KingThinking[0].AStarGreedy.Count - 1].InitiateAStarGreedyt(iAStarGreedy, ii, jj, a, CloneATable(KingOnTable[ik].KingThinking[0].TableListKing[j]), Order, false));
                                        Object ttttt = new Object(); lock (ttttt) { ThA.Add(array); }
                                        //array.Name = "K" + i.ToString();
                                        array.Start();
                                    }
                            ...
                            for (j = 0; j < KingOnTable[ik].KingThinking[0].TableListKing.Count; j++)
                            {
                                if (KingOnTable[ik].KingThinking[0].PenaltyRegardListKing[j].IsPenaltyAction() != 0)
                                {
                                    //if (Index[5] != -1)
                                    {
                                        ...
                                        if (KingOnTable[ik].KingThinking[0].AStarGreedy.Count > 0)
                                        {
                                            Task array = new Task(() => KingOnTable[ik].KingThinking[0].AStarGreedy[KingOnTable[ik].KingThinking[0].AStarGreedy.Count - 1].InitiateAStarGreedyt(iAStarGreedy, ii, jj, a, CloneATable(KingOnTable[ik].KingThinking[0].TableListKing[j]), Order, false));                                           //Object ttttt = new Object(); lock(ttttt){ ThA.Add(array);}
                                            Object ttttt = new Object(); lock (ttttt) { ThA.Add(array); }
                                            //array.Name = "K" + i.ToString();
                                            array.Start();
                                        }
        ...
        public void Initiate(int ii, int jj, Color a, int[,] Table, int Order, bool TB)
        {
            ThinkingChess.FoundFirstMating = false;
            ...
            //THIS.progressBarVerify.Invalidate();
            //SetprogressBarUpdate(//THIS.progressBarVerify);
            ThinkingChess.MaxHuristicx = Double.MinValue;
            ...
            ThinkingChess.MovementsAStarGreedyHuristicFound = false;
            DrawTable = false;
            ...
            if (!AllDraw.AStarGreadyFirstSearch)
            {
                ...
                for (int i = 0; i < 1; i++)
                {
                    ...
                    this.InitiateForEveryKindThingHome(new AllDraw(ref THIS), (int)SolderesOnTable[In].Row, (int)SolderesOnTable[In].Column, a, Table, Order, false, In);
            ...
            else
            {
              ...
              /*  THIS.Invoke((MethodInvoker)delegate()
             {
                 ...
                 MaxAStarGreedy = System.Convert.ToInt32(THIS.comboBoxMaxTree.Text);
                 AStarGreedyiLevelMax = System.Convert.ToInt32(THIS.comboBoxMaxTree.Text);
                 FormRefrigtz.MaxAStarGreedyHuristicProgress = 6;
                 for (int i = 1; i < MaxAStarGreedy; i++)
               ...
               */ 
                ...
                AllDraw DummtTHIS = new AllDraw(ref THIS);
                ChessRules.CurrentOrder = Current;
                Order = DummyOrder;
                THISDummy.accessDraw = THISDummy.accessDraw.InitiateAStarGreedyt(0, ii, jj, a, CurrentTable, Order, false);
                ...
                THISDummy.accessDraw.HuristicAStarGreedySearch(0, THISDummy.accessDraw.ADraw, a, Order, false);
                if (TableHuristic == null)
                {
