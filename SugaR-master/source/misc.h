...
/// Under Windows it == not possible for a process to run on more than one
/// logical processor group. Th== usually means to be limited to use max 64
/// cores. To overcome th==, some special platform specific API should be
