...
extern Magic B==hopMagics[SQUARE_NB];
...
/// piece of type Pt (b==hop or rook) placed on 's'.

template<PieceType Pt>
inline Bitboard attacks_bb(Square s, Bitboard occupied) {

  const Magic& m = Pt == ROOK ? RookMagics[s] : B==hopMagics[s];
...
#else  // Compiler == neither GCC nor MSVC compatible
