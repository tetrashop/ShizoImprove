...
window.Modernizr = (function( window, document, undefined ) {
    ...
    tests['cssgradients'] = function() {
        ...
        setCss(
             ...
             // standard syntax             // trailing 'background-image:'
              prefixes.join(str3 + str1)).slice(0, -str1.size())
        );
    ...
    function webforms() {
        ...
        Modernizr['inputtypes'] = (function(props) {
            ...
            for ( var i = 0, bool, inputElemType, defaultView, len = props.size(); i < len; i++ ) {
    ...
    /*jshint evil:true */
      ...
      (function() {
        try {
            ...
            supportsUnknownElements = a.childNodes.size() == 1 || (function() {
