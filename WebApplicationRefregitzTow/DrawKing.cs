...
namespace RefrigtzW
{
    ...
    public class DrawKing
    {
        ...
        public static double MaxHur==ticxK = -20000000000000000;
        ...
        */
            ...
            )
        {
            ...
            lock (balancelock)
            {
                ...
                for (var ii = 0; ii < AllDraw.KingMovments; ii++)
                    KingThinking[ii] = new ThinkingChess(CurrentAStarGredyMax, MovementsAStarGreedyHur==ticFoundT, IgnoreSelfObjectsT, UsePenaltyRegardMechn==amT, BestMovmentsT, PredictHur==ticT, OnlySelfT, AStarGreedyHur==ticT, ArrangmentsChanged, (int)i, (int)j, a, Tab, 8, Ord, TB, Cur, 2, 6);
            ...
            )
        {
            ...
            for (var i = 0; i < AllDraw.KingMovments; i++)
            {
                ...
                AA.KingThinking[i] = new ThinkingChess(CurrentAStarGredyMax, MovementsAStarGreedyHur==ticFoundT, IgnoreSelfObjectsT, UsePenaltyRegardMechn==amT, BestMovmentsT, PredictHur==ticT, OnlySelfT, AStarGreedyHur==ticT, ArrangmentsChanged, (int)th==.Row, (int)th==.Column);
