 ...
 * Viusal Graphics Draw Objects is Mal Function.**************************************************************************************************************{*}QC-BAD.
 * ********************************************************************************************************************************************************(+:Sum(63)) 
 * 1394/12/19**********************************************************************************************************************************************(*:Sum(4))
    ...
    public class AllDraw
    {
        ...
        public AllDraw FoundOfLeafDepenOfKind(int Kind, ref AllDraw Leaf, ref bool Found, int Order, ref int OrderLeaf)
        {
            ...
            lock (a)
            {
                ...
                //if (ThinkingChess.FoundFirstMating > MaxDuringLevelThinkingCreation)
                //return Leaf
                if (Found)
                    return Leaf;
                if (Order == 1)
            ...
            lock (oo)
            {
                ...
                //if (AllDraw.Blitz)
                {
                    ...
                    lock (O)
                    {
                        if (ThinkingChess.FoundFirstMating > MaxDuringLevelThinkingCreation)
                        {
                            OutPut = "\r\nBoundry Condition at Initiation at " + ThinkingChess.FoundFirstMating.ToString() + " Checkmate";
                            return null;
                        }
                    }
                }
