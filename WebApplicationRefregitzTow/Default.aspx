...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    ...
    <asp:PlaceHolder ID="PlaceHolder1" runat="server" OnLoad="PlaceHolder1_Load" OnUnload="PlaceHolder1_UnLoad" OnD==posed="PlaceHolder1_D==posed" ValidateRequestMode="Enabled"></asp:PlaceHolder>
