...
namespace RefrigtzDLL
{
    public class ThinkingChess
    {
        ...
        //Constructor
        public ThinkingChess(int CurrentAStarGredy,
        ...
        bool Arrangments, int i, int j, Color a, int[,] Tab, int Ma, int Ord, bool ThinkingBeg, int CurA, int ThingN, int Kin)
        {
        ...
        int GetObjectValueHuristic(int[,] Tabl, int ii, int jj, int Order)
        {
            return ObjectValueCalculator(Tabl, Order, ii, jj);
        }
        ///.
        ...
        {
            int Val = 0;
            //int Val = ObjectValueCalculator(Tabl, Order, ii, jj);
        ...
        double HuristicObjectDangour(int[,] Table, int Order, Color a, int i, int j, int ii, int jj
            )
        {
            ...
            try
            {
                if (!AStarGreedyHuristicT)
                {
                    ...
                    if (ObjectDanger(Table, ii, jj, i, j, a, Order))
                    {
                        ...
                        HA += Sign * (GetObjectValue(Table, ii, jj, Order) + GetObjectValue(Table, i, j, Order));
                    }
                }
        ...
        double HuristicKiller(int Killed, int[,] Tabl, int i, int j, int ii, int jj, int Ord, Color aa, bool Hit//, ref double HuristicKillerValue
            )
        {
            int[,] Tab = new int[8, 8];
        ...
        //Calculate List of Attacable Enemy Objects. 
        bool InAttackEnemyThatIsNotSupportedCalculateValuableAll(int[,] Table, int Order, Color a, int ij, int ji, int iij, int jji, ref List<int[]> ValuableEnemyNotSupported
        )

        {
                ...
                for (int j = 0; j < 8; j++)
                {
                    ...
                    for (int ii = 0; ii < 8; ii++)
                    {
                        for (int jj = 0; jj < 8; jj++)
                        {
                            ...
                            //When there is Attack on Enemies.
                            Object O = new Object();
                            lock (O)
                            {
                                ...
                                if (EnemyNotSupported && InAttackedNotEnemySupported)
                                {
                                    ...
                                    Valu[1] = ii;
                                    Valu[2] = jj;
                                    if (!ExistValuble(Valu, ref ValuableEnemyNotSupported))
                                        ValuableEnemyNotSupported.Add(Valu);
                                }
                            }
                        }
                        //if (!S)
            ...
            if (ValuableEnemyNotSupported.Count > 1)
            {
                Order = Ord;
                return true;
            }
        ...
        int IsNotSafeToMoveAenemeyToAttackMoreThanTowObject(int AttackCount,
            ...
            )
        {
                                        ...
                                        Parallel.For(0, 8, jjj =>
                                            ...
                                            if (Order == 1 && Tab[iii, jjj] <= 0)
                                                ...
                                                if (Order * -1 == -1)
                                                    a = Color.Brown;
                                            //when there is attack to some self node.
                                            if (Attack(Tab, ii, jj, iii, jjj, a, Order * -1))
                                                {
                                                    bool Supporte = false;
                                                //For All Self
                                                Parallel.For(0, 8, iiii =>
                                                    {
                                                        if (AttackCount > 1)
                                                            return;
                                                        Parallel.For(0, 8, jjjj =>
                                                        {
                                                            if (AttackCount > 1)
                                                                return;
                                                        ...
                                                        if (Support(Tab, iiii, jjjj, iii, jjj, a, Order) || Attack(Tab, iiii, jjjj, ii, jj, a, Order))
                                                            {
            ...
            //if(AttackCount>1)
            //IsNotSafeToMoveAenemeyToAttackMoreThanTowObjectV = true;
            //return IsNotSafeToMoveAenemeyToAttackMoreThanTowObjectV;
            return AttackCount;
        }
        //When there is another self object that is on attacke retun true.
        int IsAnotherObjectMakeDangoure(int[,] TableS, int Order, Color a, int ObjRow, int ObjCol, int CurDangRow, int CurDangCol)
        {
            int Is = 0;
            //For All Current
            for (int i = 0; i < 8; i++)
        ...
        bool InAttackSelfThatNotSupportedAll(//bool IsTowValuableObject,
            int[,] TableS, int Order, Color a, int i, int j, int iii, int jjj, int ikk, int jkk, int iik, int jjk
            //,ref List<int[]>ValuableSelfSupported
            )
        {
                        ...
                        for (int jjj = 0; jjj < 8; jjj++)
                        {
                            ...
                            lock (O1)
                            {
                                ...
                                )
                                {
                                    ...
                                    if (!S)
                                    {
                                        int[] Valuable = new int[3];//First is Value;Second and Third is Row and Column.
        ...
        bool isCurrentMoveTakeSupporte(int[,] Table, int Order, Color a, int i, int j, int ii, int jj)
        {
            ...
            for (int iii = 0; iii < 8; iii++)
            {
                for (int jjj = 0; jjj < 8; jjj++)
                {
                    ...
                    if (Support(Tab, iii, jjj, ii, jj, a, Order))
                        SelfSupported = true;
                }
            }
        ...
        double HeuristicKingSafety(int[,] Tab, int Order, Color a, int i, int j, int iii, int jjj//, ref double HeuristicKingSafe
            , int CurrentAStarGredy)
        {
            ...
            Parallel.For(0, 8, ii =>
            {
                Parallel.For(0, 8, jj =>
                {
                    ...
                    if (Order == -1 && Tab[ii, jj] <= 0)
                        return;
                    ChessRules A = new ChessRules(CurrentAStarGredy, MovementsAStarGreedyHuristicFoundT, IgnoreSelfObjectsT, UsePenaltyRegardMechnisamT, BestMovmentsT, PredictHuristicT, OnlySelfT, AStarGreedyHuristicT, ArrangmentsChanged, Tab[ii, jj], Tab, Order * -1, ii, jj);
                    ...
                    Parallel.For(0, 8, iiii =>
                    {
                        Parallel.For(0, 8, jjjj =>
                        {
                            ...
                            lock (O)
                            {
                                if (A.Rules(ii, jj, iiii, jjjj, AA, Table[ii, jj]))
                                {
                                    //Take Movment.
        ...
        double HeuristicKingDangourous(int[,] Tab, int Order, Color a, int i, int j, int iii, int jjj//, ref double HeuristicKingSafe
           , int CurrentAStarGredy)
        {
            ...
            Parallel.For(0, 8, ii =>
            {
                Parallel.For(0, 8, jj =>
                {
                    ...
                    if (Order == -1 && Tab[ii, jj] >= 0)
                        return;
                    ChessRules A = new ChessRules(CurrentAStarGredy, MovementsAStarGreedyHuristicFoundT, IgnoreSelfObjectsT, UsePenaltyRegardMechnisamT, BestMovmentsT, PredictHuristicT, OnlySelfT, AStarGreedyHuristicT, ArrangmentsChanged, Tab[ii, jj], Tab, Order, ii, jj);
                    //For Enemy and Empty.
                    Parallel.For(0, 8, iiii =>
                    {
                        Parallel.For(0, 8, jjjj =>
            ...
            //For Order Sign.
            HeuristicKingDangour += HA * SignOrderToPlate(Order);
            return HeuristicKingDangour;
        }
        //Huristic of Supportation.
        double HuristicSelfSupported(int[,] Tab, int Ord, Color aa, int i, int j, int ii, int jj
            )
        ...
        /*public bool IsNextMovmentIsCheckOrCheckMateForCurrentStatic(int[,] Table, int Order, Color color, int i, int j)
        {
            bool Is = false; ;
            for (int ik = 0; ik < 8; ik++)
                for (int jk = 0; jk < 8; jk++)
                {
                    //Ignore of Enemy.
                    if (Order == 1 && Table[ik, jk] < 0)
                        continue;
                    if (Order == -1 && Table[ik, jk] > 0)
                        continue;
                    Is = Is || IsNextMovmentIsCheckOrCheckMateForCurrentMovment(Table, Order, color, i, j, ik, jk, 0, Order);
                }
            return Is;
        }
         */
        ...
        int[] IsNextMovmentIsCheckOrCheckMateForCurrentMovment(int[,] Tabl, int Order, Color a,
            //int i,//First Row
            //int j,//First Column
            //int ii,//Second Row
            //int jj,
            int Depth,
            int OrderPalte, int OrderPalteMinusPluse, bool KindCheckedSelf
            )
        {
        ...
        bool IsGardForCurrentMovmentsAndIsNotMovable(int[,] Tab, int Order, Color a, int ii, int jj, int iii, int jjj//,int iiii,int jjjj,int iiiii,int jjjjj
            )
        {
            //Setting false.
            bool Attacked = true;
                ...
                //for (int jj = 0; jj < 8; jj++)
                {
                    ...
                    //for (int iii = 0; iii < 8; iii++)
                    {
                        ...
                        //for (int jjj = 0; jjj < 8; jjj++)
                        {
                            ...
                            if (Attack(Tab, ii, jj, iii, jjj, aa, Order * -1) && (GetObjectValue(Tab, ii, jj, Order * -1) < GetObjectValue(Tab, iii, jjj, Order)))
                            {
                                    ...
                                    Parallel.For(0, 8, jjjj =>
                                    {
                                        ...
                                        Parallel.For(0, 8, iiiii =>
                                        {
                                            Parallel.For(0, 8, jjjjj =>
                                            {
                                                ...
                                                lock (O)
                                                {
                                                    if ((new ChessRules(CurrentAStarGredyMax, MovementsAStarGreedyHuristicFoundT, IgnoreSelfObjectsT, UsePenaltyRegardMechnisamT, BestMovmentsT, PredictHuristicT, OnlySelfT, AStarGreedyHuristicT, ArrangmentsChanged, TabS[iiii, jjjj], TabS, Order, iiii, jjjj)).Rules(iiii, jjjj, iiiii, jjjjj, a, TabS[iiii, jjjj]))
                                                    {
            ...
            //Return Variable when true show an object is not movable or one enemy object attack more than one current Object.
        ...
        bool IsCurrentCanGardHighPriorityEnemy(int Depth, int[,] Table, int Order, Color a,
            int ij,//First Row
            int ji,//First Column
            int iij,//Second Row
            int jji,//Second Column
            int OrderPlate
            )
        {
                ...
                lock (O)
                {
                    ...
                    AA.ObjectDangourKingMove(Order, Table, false);
                    {
                        ...
                        {//When is Brown CheckedMate.
                            ...
                            {
                                HA += CheckMate;
                                //HA += (CheckMate * SignOrderToPlate(DummyOrder));
                        ...
                        if (A.CheckGray || A.CheckBrown)
                        {
                            ...
                            {
                                HA += Check;
                                //HA += (Check * SignOrderToPlate(DummyOrder));
                                MovementsAStarGreedyHuristicFoundT = true;
                            }
                            //When is Brown Check.
                        ...
                        if (AA.CheckGrayObjectDangour || AA.CheckBrownObjectDangour)
                        {
                            ...
                            {
                                HA += ObjectDangour;
                                //HA += (ObjectDangour * SignOrderToPlate(DummyOrder));
                                MovementsAStarGreedyHuristicFoundT = true;
                            }
                            //when is Gray Objects Dangoure.
        ...
        public double HeuristicDistabceOfCurrentMoveFromEnemyKing(int[,] Tab, int Order, int ii, int jj//, ref double HeuristicDistabceOfCurrentMoveFromEnemyKingValue
            )
        {
            ...
            ChessRules A = new ChessRules(CurrentAStarGredyMax, MovementsAStarGreedyHuristicFoundT, IgnoreSelfObjectsT, UsePenaltyRegardMechnisamT, BestMovmentsT, PredictHuristicT, OnlySelfT, AStarGreedyHuristicT, ArrangmentsChanged, Tab[ii, jj], Tab, Order, ii, jj);
            double Dis = 0;
            //Order is  Gray.
            if (Order == -1)
            {
                ...
                if (System.Math.Abs(Tab[ii, jj]) == 1)
                    Dis = AllDraw.SignDistance * //(1.0 / (double)SodierValue) * 
                        System.Math.Sqrt(System.Math.Pow(ii - RowG, 2) + System.Math.Pow(jj - ColumnG, 2));
                else
                    //When Elephant.
                    if (System.Math.Abs(Tab[ii, jj]) == 2)
                    Dis = AllDraw.SignDistance * //(1.0 / (double)ElefantValue) *
                        System.Math.Sqrt(System.Math.Pow(ii - RowG, 2) + System.Math.Pow(jj - ColumnG, 2));
                else
                        //When Hourse.
                        if (System.Math.Abs(Tab[ii, jj]) == 3)
                    Dis = AllDraw.SignDistance * //(1.0 / (double)HourseValue) * 
                        System.Math.Sqrt(System.Math.Pow(ii - RowG, 2) + System.Math.Pow(jj - ColumnG, 2));
                else
                            //When Castles.
                            if (System.Math.Abs(Tab[ii, jj]) == 4)
                    Dis = AllDraw.SignDistance * //(1.0 / (double)CastleValue) * 
                        System.Math.Sqrt(System.Math.Pow(ii - RowG, 2) + System.Math.Pow(jj - ColumnG, 2));
                else
                                //When minister.
                                if (System.Math.Abs(Tab[ii, jj]) == 5)
                    Dis = AllDraw.SignDistance * //(1.0 / (double)MinisterValue) * 
                        System.Math.Sqrt(System.Math.Pow(ii - RowG, 2) + System.Math.Pow(jj - ColumnG, 2));
                else
                                    //When King.
                                    if (System.Math.Abs(Tab[ii, jj]) == 6)
                    Dis = AllDraw.SignDistance * //(1.0 / (double)KingValue) * 
                        System.Math.Sqrt(System.Math.Pow(ii - RowG, 2) + System.Math.Pow(jj - ColumnG, 2));
                // Dis = -1000.0;
                HeuristicDistabceOfCurrentMoveFromEnemyKingValue += Dis * SignOrderToPlate(Order);
            }
            //Brown Order.
            else
            {
                ...
                if (System.Math.Abs(Tab[ii, jj]) == 1)
                    Dis = AllDraw.SignDistance * //(1.0 / (double)SodierValue) * 
                        System.Math.Sqrt(System.Math.Pow(ii - RowB, 2) + System.Math.Pow(jj - ColumnB, 2));
                else
                    //When Elephant.
                    if (System.Math.Abs(Tab[ii, jj]) == 2)
                    Dis = AllDraw.SignDistance * //(1.0 / (double)ElefantValue) * 
        ...
        public double HuristicSoldierFromCenter(int[,] Table, Color aa, int Ord, int ii, int jj, int i, int j//, ref double HuristicMovementValue
            )
        {
            double HA = 0;
            Object O = new Object();
                ...
                if (!AStarGreedyHuristicT)
                {
                    ...
                    Parallel.For(0, 8, i =>
                    {
                        ...
                        //for (int j = 0; j < 8; j++)
                        {
                            ...
                            lock (O)
                            {
                                int i1 = i, j1 = j, iiii1 = iii, jjjj1 = jjj;
                                ...
                                int i3 = i, j3 = j, iiii3 = iii, jjjj3 = jjj;
                                ...
                                int i5 = i, j5 = j, iiii5 = iii, jjjj5 = jjj;
        ...
        public double HuristicMovment(int[,] Table, Color aa, int Ord, int i, int j, int ii, int jj//, ref double HuristicMovementValue
        )
        {
        ...
        {
            /*if (AllDraw.RegardOccurred)
            {
                if (System.Math.Abs(Kind) == 1 && PenaltyRegardListSolder[j].IsRewardAction() != 1)
                    return Double.MinValue;
                else
                    if (System.Math.Abs(Kind) == 2 && PenaltyRegardListElefant[j].IsRewardAction() != 1)
                        return Double.MinValue;
                    else
                        if (System.Math.Abs(Kind) == 3 && PenaltyRegardListHourse[j].IsRewardAction() != 1)
                            return Double.MinValue;
                        else
                            if (System.Math.Abs(Kind) == 4 && PenaltyRegardListCastle[j].IsRewardAction() != 1)
                                return Double.MinValue;
                            else
                                if (System.Math.Abs(Kind) == 5 && PenaltyRegardListMinister[j].IsRewardAction() != 1)
                                    return Double.MinValue;
                                else
                                    if (System.Math.Abs(Kind) == 6 && PenaltyRegardListKing[j].IsRewardAction() != 1)
                                        return Double.MinValue;
                    ...
                    for (int i = 0; i < AStarGreedy.Count; i++)
                    {
                        ...
                        for (int m = 0; m < CastleOnTableCount(ref AStarGreedy[i].CastlesOnTable, true); m++)
                        {
                            ...
                            if (AStarGreedy[i].CastlesOnTable[m] != null)
                            {
                                ...
                                if (AStarGreedy[i].CastlesOnTable[m].CastleThinking[0].MaxHuristic(ref jIndex[3], 4, ref Less[3], Order))
                                {
                                    iIndex[3] = i;
                                    mIndex[3] = m;
                                    Kin[3] = 4;
                        ...
                        for (int m = 0; m < MinisterOnTableCount(ref AStarGreedy[i].MinisterOnTable, true); m++)
                        {
                            ...
                            if (AStarGreedy[i].MinisterOnTable[m] != null)
                            {
                                ...
                                if (AStarGreedy[i].MinisterOnTable[m].MinisterThinking[0].MaxHuristic(ref jIndex[4], 5, ref Less[4], Order))
                                {
                                    iIndex[4] = i;
                                    mIndex[4] = m;
                                    Kin[4] = 5;
                        ...
                        for (int m = 0; m < KingOnTableCount(ref AStarGreedy[i].KingOnTable, true); m++)
                        {
                            ...
                            if (AStarGreedy[i].KingOnTable[m] != null)
                            {
                                ...
                                if (AStarGreedy[i].KingOnTable[m].KingThinking[0].MaxHuristic(ref jIndex[5], 1, ref Less[5], Order))
                                {
                                    iIndex[5] = i;
                                    mIndex[5] = m;
                                    Kin[5] = 6;
        ...
        //Determine when current movment is not suitable and is dangrous return ture.QC_OK
        bool IsThereCurrentMovmentDangrous(
            int[,] Table,
            //int ii,//First Row
            //int jj,//First Column
            //int iii,//Second Row
            //int jjj,//Second Column            
            int Order, Color a)
        {
            //setting false.
            ...
            for (int i = 0; i < 8; i++)
            {
                for (int j = 0; j < 8; j++)
                {
                    ...
                    for (int aaa = 0; aaa < 8; aaa++)
                    {
                        ...
                        {
                            //Ignore of Enemy.QC-OK
                            if ((Order == -1) && Table[aaa, bbb] < 0)
                                continue;
                            else
                                if ((Order == 1) && Table[aaa, bbb] > 0)
                                continue;
                            ...
                            if (Order * -1 == -1)
                                s = Color.Brown;
                            if (A.Rules(i, j, aaa, bbb, s, Table[i, j]))
                            {
                                int[,] Tab = new int[8, 8];
                                for (int ik = 0; ik < 8; ik++)
                                    for (int jk = 0; jk < 8; jk++)
                                ...
                                for (int aa = 0; aa < 8; aa++)
                                {
                                    ...
                                    {
                                        //Ignore of Enemy.QC-OK
                                        if ((Order == -1) && Tab[aa, bb] >= 0)
                                            continue;
                                        else
                                            if ((Order == 1) && Tab[aa, bb] <= 0)
                                            continue;

                                        if (Attack(Tab, aaa, bbb, aa, bb, s, Order * -1) && (GetObjectValue(Tab, aaa, bbb, Order * -1) <= GetObjectValue(Tab, aa, bb, Order)))
                                        {
                                            IsDangreous = true;
                                            break;
                                        }
        ...
        void KingThinkingChess(int DummyOrder, int DummyCurrentOrder, int[,] TableS, int ii, int jj, bool DoEnemySelf, bool PenRegStrore, bool EnemyCheckMateActionsString, int i, int j, bool Castle, ChessRules AAA
            ...
            , ref double HeuristicFromCenter*/)
        {
            ...
            if ((new ChessRules(CurrentAStarGredyMax, MovementsAStarGreedyHuristicFoundT, IgnoreSelfObjectsT, UsePenaltyRegardMechnisamT, BestMovmentsT, PredictHuristicT, OnlySelfT, AStarGreedyHuristicT, ArrangmentsChanged, TableS[ii, jj], TableS, Order, ii, jj)).Rules(ii, jj, i, j, color, TableS[ii, jj]))
            {
                ...
                //Learning Autamata
                //if (PenaltyMechanisam(Killed,true, 6, TableS, i, j, ref Current, DoEnemySelf, PenRegStrore, EnemyCheckMateActionsString, ii, jj, Castle))
                //if (!KishBefore)
                //return;
                ...
                //if (Current.IsPenaltyAction() != 0 || KishBefore)
                {
                    //RemoveAtList(Kind);
                    //Learning Autamata
            ...
            , ref double HeuristicFromCenter*/)
        {
            ...
            if ((new ChessRules(CurrentAStarGredyMax, MovementsAStarGreedyHuristicFoundT, IgnoreSelfObjectsT, UsePenaltyRegardMechnisamT, BestMovmentsT, PredictHuristicT, OnlySelfT, AStarGreedyHuristicT, ArrangmentsChanged, TableS[ii, jj], TableS, Order, ii, jj)).Rules(ii, jj, i, j, color, TableS[ii, jj]))
            {
                ...
                //Learning Autamata
                //if (PenaltyMechanisam(Killed,true, 5, TableS, i, j, ref Current, DoEnemySelf, PenRegStrore, EnemyCheckMateActionsString, ii, jj, Castle))
                //if (!KishBefore)
                //return;
                int Killed = 0;
                Object A2 = new object();
        ...
        /*, ref bool IsCurrentCanGardHighPriorityEne
        , ref bool IsNextMovemntIsCheckOrCheckMateForCurrent
        , ref bool IsDangerous
        , ref bool CanKillerAnUnSupportedEnemy
        , ref bool InDangrousUnSupported
        , ref bool Support
        , ref bool IsNextMovemntIsCheckOrCheckMateForEnemy
        , ref bool IsPrviousMovemntIsDangrousForCurr
        , ref bool PDo
        , ref bool RDo
    , ref bool SelfCheckMateActionsString,
     ref bool AchamazCurrent,
        ref bool SelfNotSupported,
        ref bool EnemyNotSupported,
        ref bool IsGardForCurrentMovmentsAndIsNotMova,
        ref bool IsNotSafeToMoveAenemeyToAttackMoreThanTowObj*/
        ...
        )
        {
            ...
            bool PDo = new bool();
            bool RDo = new bool();
            //bool SelfCheckMateActionsString= new bool();
            //bool AchamazCurrent= new bool();
            ...
            //IsTowValuableObjectEnemy = InAttackEnemyThatIsNotSupportedCalculateValuableAll(TableS, Order, color, i, j, ii, jj);
            ...
            lock (O)
            {
                ...
                Support = false;
                /*if (CurrentAStarGredyMax == 0 && (!SelfNotSupported))
                {
                    Support = true;
                    //The Mechanisam Support most Current Objects that is from Initiate state.
                    int SuppportCount = 0;
                    for (int ij = 0; ij < 8; ij++)
                        for (int ji = 0; ji < 8; ji++)
                        {
                            if (Order == 1 && TableS[ij, ji] <= 0)
                                continue;
                            else
                                if (Order == -1 && TableS[ij, ji] >= 0)
                                    continue;

                            SuppportCount += SupporterCount(TableS, Order, color, ij, ji);
                        }
                    //when is true must regard.
                    if (Order == 1)
                    {
                        if (SuppportCount > AllDraw.SuppportCountStaticGray)
                        {
                            Support = true;
                            AllDraw.SuppportCountStaticGray = SuppportCount;
                        }
                        else
                            Support = false;
                    }
                    ...
                    {
                        if (SuppportCount > AllDraw.SuppportCountStaticBrown)
                        {
                            Support = true;
                            AllDraw.SuppportCountStaticBrown = SuppportCount;
                        }
                        else
                            Support = false;
                    }
                ...
                //Support = isCurrentMoveTakeSupporte(TableS, Order, color, i, j, ii, jj);
                //IsDangerous = IsThereCurrentMovmentDangrous(i, j, ii, jj, Order, color);
                ...
                /*if ((!SelfNotSupported) && (!IsPrviousMovemntIsDangrousForCurr))
                {
                    SelfNotSupported = InAttackSelfThatNotSupportedAll(IsTowValuableObject, TableS, Order, color//, ii, jj, i, j
                        , ref ValuableSelfSupported);
                }*/
                //For Penalty.
                /*if ((!SelfNotSupported) && (!IsPrviousMovemntIsDangrousForCurr))
                {
                    IsNotSafeToMoveAenemeyToAttackMoreThanTowObj = IsNotSafeToMoveAenemeyToAttackMoreThanTowObject(TableS, Order);
                }*/

                //when true must penalty.
                /*if ((!SelfNotSupported) && (!IsPrviousMovemntIsDangrousForCurr) && (!IsNotSafeToMoveAenemeyToAttackMoreThanTowObj))
                    IsGardForCurrentMovmentsAndIsNotMova = IsGardForCurrentMovmentsAndIsNotMovable(TableS, Order, color//, i, j
                        );
                        */

                /*if ((!SelfNotSupported) && (!IsPrviousMovemntIsDangrousForCurr) && (!IsGardForCurrentMovmentsAndIsNotMova) && (!IsNotSafeToMoveAenemeyToAttackMoreThanTowObj))
                {
                    SelfNotSupported = InAttackSelfThatNotSupportedAll(IsTowValuableObject, TableS, Order, color, ii, jj, i, j, ref ValuableSelfSupported);
                }*/
                if ((!IsNextMovemntIsCheckOrCheckMateForCurrent) && (!SelfNotSupported) && (!IsPrviousMovemntIsDangrousForCurr) && (!IsGardForCurrentMovmentsAndIsNotMova) && (!IsNotSafeToMoveAenemeyToAttackMoreThanTowObj) && (!IsDangerous))
                {
                    ...
                    if (CurrentAStarGredyMax == 0)
                    {
                        ...
                        Is = IsNextMovmentIsCheckOrCheckMateForCurrentMovment(Tab, Ord, a//, i, j, //ik                           
                                                                                         //ii
                                                                                         //, jj
                            , Depth, Ord1, Ord2, true);
                        //A
                ...
                {
                    IsDangerous = IsThereCurrentMovmentDangrous(TableS, Order, color);
                }*/
                if ((!IsNextMovemntIsCheckOrCheckMateForCurrent) && (!SelfNotSupported) && (!IsPrviousMovemntIsDangrousForCurr) && (!IsGardForCurrentMovmentsAndIsNotMova) && (!IsNotSafeToMoveAenemeyToAttackMoreThanTowObj) && (!IsDangerous))
                {
        ...
        void CastlesThinkingChess(int DummyOrder, int DummyCurrentOrder, int[,] TableS, int ii, int jj, bool DoEnemySelf, bool PenRegStrore, bool EnemyCheckMateActionsString, int i, int j, bool Castle
            /*, ref double HuristicAttackValue
                , ref double HuristicMovementValue
                , ref double HuristicSelfSupportedValue
                , ref double HuristicObjectDangourCheckMateValue
            ...
            , ref double HeuristicFromCenter*/)
        {
            ...
            if ((new ChessRules(CurrentAStarGredyMax, MovementsAStarGreedyHuristicFoundT, IgnoreSelfObjectsT, UsePenaltyRegardMechnisamT, BestMovmentsT, PredictHuristicT, OnlySelfT, AStarGreedyHuristicT, ArrangmentsChanged, TableS[ii, jj], TableS, Order, ii, jj)).Rules(ii, jj, i, j, color, TableS[ii, jj]))
            {
                QuantumAtamata Current = new QuantumAtamata(3, 3, 3);
                ThinkingAtRun = true;
                //CastleValue = ObjectValueCalculator(TableS, Order, ii, jj);
                ...
                //Learning Autamata
                //if (PenaltyMechanisam(Killed,true, 4, TableS, i, j, ref Current, DoEnemySelf, PenRegStrore, EnemyCheckMateActionsString, ii, jj, Castle))
                //if (!KishBefore)
                //return;
                int Killed = 0;
                Object A2 = new object();
                ...
                ///Consideration of Itterative Movments to ignore.
                /*if (ExistTableInList(TableS, TableListCastle, 0))
                {
                    ///Set Predict Huristic and Movments Backward.
                    TableS[ii, jj] = TableS[i, j];
                    TableS[i, j] = 0;
                ...
                //CastleValue = ObjectValueCalculator(TableS, Order, i, j);
                //if (Order == AllDraw.OrderPlate)
                {
                    Object A5 = new object();
                    lock (A5)
        ...
        void HourseThinkingChess(int DummyOrder, int DummyCurrentOrder, int[,] TableS, int ii, int jj, bool DoEnemySelf, bool PenRegStrore, bool EnemyCheckMateActionsString, int i, int j, bool Castle
            /*, ref double HuristicAttackValue
                , ref double HuristicMovementValue
                , ref double HuristicSelfSupportedValue
                , ref double HuristicObjectDangourCheckMateValue
            ...
            , ref double HeuristicFromCenter*/)
        {
            ...
            if ((new ChessRules(CurrentAStarGredyMax, MovementsAStarGreedyHuristicFoundT, IgnoreSelfObjectsT, UsePenaltyRegardMechnisamT, BestMovmentsT, PredictHuristicT, OnlySelfT, AStarGreedyHuristicT, ArrangmentsChanged, TableS[ii, jj], TableS, Order, ii, jj)).Rules(ii, jj, i, j, color, TableS[ii, jj]))
            {
                ...
                //Learning Autamata
                //if (PenaltyMechanisam(Killed,true, 3, TableS, i, j, ref Current, DoEnemySelf, PenRegStrore, EnemyCheckMateActionsString, ii, jj, Castle))
                //if (!KishBefore)
                //return;
                int Killed = 0;
                Object A2 = new object();
        ...
        void ElephantThinkingChess(int DummyOrder, int DummyCurrentOrder, int[,] TableS, int ii, int jj, bool DoEnemySelf, bool PenRegStrore, bool EnemyCheckMateActionsString, int i, int j, bool Castle
                /* , ref double HuristicAttackValue
                     , ref double HuristicMovementValue
                     , ref double HuristicSelfSupportedValue
                     , ref double HuristicObjectDangourCheckMateValue
                 ...
                 , ref double HeuristicFromCenter*/)
        {
            ...
            if ((new ChessRules(CurrentAStarGredyMax, MovementsAStarGreedyHuristicFoundT, IgnoreSelfObjectsT, UsePenaltyRegardMechnisamT, BestMovmentsT, PredictHuristicT, OnlySelfT, AStarGreedyHuristicT, ArrangmentsChanged, TableS[ii, jj], TableS, Order, ii, jj)).Rules(ii, jj, i, j, color, TableS[ii, jj]))
            {
                ...
                //Learning Autamata
                //if (PenaltyMechanisam(Killed,true, 2, TableS, i, j, ref Current, DoEnemySelf, PenRegStrore, EnemyCheckMateActionsString, ii, jj, Castle))
                //if (!KishBefore)
                //return;
                Object A2 = new object();
                int Killed = 0;
        ...
        void SolderThinkingChess(int DummyOrder, int DummyCurrentOrder, int[,] TableS, int ii, int jj, bool DoEnemySelf, bool PenRegStrore, bool EnemyCheckMateActionsString, int i, int j, bool Castle
/* , ref double HuristicAttackValue
     , ref double HuristicMovementValue
     , ref double HuristicSelfSupportedValue
     , ref double HuristicObjectDangourCheckMateValue
 ...
 , ref double HeuristicFromCenter*/
)
        {
            ...
            if ((new ChessRules(CurrentAStarGredyMax, MovementsAStarGreedyHuristicFoundT, IgnoreSelfObjectsT, UsePenaltyRegardMechnisamT, BestMovmentsT, PredictHuristicT, OnlySelfT, AStarGreedyHuristicT, ArrangmentsChanged, TableS[ii, jj], TableS, Order, ii, jj)).Rules(ii, jj, i, j, color, TableS[ii, jj]))
            {
                ...
                //Learning Autamata
                //if (PenaltyMechanisam(Killed,true, 1, TableS, i, j, ref Current, DoEnemySelf, PenRegStrore, EnemyCheckMateActionsString, ii, jj, Castle))
                //if (!KishBefore)
                //return;
                int Killed = 0;
                Object A2 = new object();
                ...
                lock (O8)
                {
                    ...
                    if (Order == 1)
                        ...
                        AllDraw.OutPut = "\r\nThinking Soldeir AstarGreedy By Level " + CurrentAStarGredyMax.ToString() + " Alice at " + ThinkingLevel.ToString() + "th Thinking String " + OutPutAction;
                    ThinkingLevel++;
        ...
        void CastleThinkingBrown(int DummyOrder, int DummyCurrentOrder, int[,] TableS, int ii, int jj, bool DoEnemySelf, bool PenRegStrore, bool EnemyCheckMateActionsString, int i, int j, bool Castle
            /*, ref double HuristicAttackValue
                , ref double HuristicMovementValue
                , ref double HuristicSelfSupportedValue
                , ref double HuristicObjectDangourCheckMateValue
            ...
            , ref double HeuristicKingDangour)
        {
            ...
            Object O = new Object();
             ...
             Object O = new Object();
                 lock (O)
                 {
                     HDistance = HeuristicDistabceOfCurrentMoveFromEnemyKing(TableSS, Order, i, j//, ref HeuristicDistabceOfCurrentMoveFromEnemyKingValue
                          );
                 }
             }
             , () =>
             ...
             Object O = new Object();
                 lock (O)
                 {
                     HKingSafe = HeuristicKingSafety(TableSS, Order, color, i, j, ii, jj//, ref HeuristicKingSafe
               ...
               Object O = new Object();
                   lock (O)
                   {
                       HKingDangour = HeuristicKingDangourous(TableSS, Order, color, i, j, ii, jj//, ref HeuristicKingSafe
                       , CurrentAStarGredyMax);
                   }
               }
               , () =>
               ...
               Object O = new Object();
                   lock (O)
                   {
                       HFromCenter = HuristicSoldierFromCenter(TableSS, color, Order, i, j, ii, jj);
                   }
               }
            );
            Object O1 = new Object();
        ...
        public void HuristicPenaltyValuePerform(QuantumAtamata Current, int Order, ref double HuristicAttackValue
            , bool AllDrawClass = false)
        {
        ...
        public void ThinkingSoldierBase(int ord, int ii, int jj, int i, int j, int DummyOrder, int DummyCurrentOrder, bool DoEnemySelf, bool PenRegStrore, bool EnemyCheckMateActionsString, bool Castle)
        {
...
/*, ref HuristicAttackValue
, ref HuristicMovementValue
, ref HuristicSelfSupportedValue
, ref HuristicObjectDangourCheckMateValue
, ref HuristicKillerValue
, ref HuristicReducedAttackValue
...
, ref HeuristicFromCenter*/
        ...
        public void ThinkingSoldier(int ord, int ii, int jj, int DummyOrder, int DummyCurrentOrder, bool DoEnemySelf, bool PenRegStrore, bool EnemyCheckMateActionsString, bool Castle)
        {
            ...
            Parallel.For(ii - 2,  ii + 2, i=>
            {
                Parallel.For(jj - 2, jj + 2, j =>
                {
                    ...
                    lock (O)
                    {
                       while (ThinkingAtRun) {  }
                        if (Scop(ii, jj, i, j, 1))
                            ThinkingSoldierBase(ord, ii, jj, i, j, DummyOrder, DummyCurrentOrder, DoEnemySelf, PenRegStrore, EnemyCheckMateActionsString, Castle);
                        ThinkingAtRun = false;
                    }
        ...
        public void ThinkingElephantBase(int ord, int ii, int jj, int i, int j, int DummyOrder, int DummyCurrentOrder, bool DoEnemySelf, bool PenRegStrore, bool EnemyCheckMateActionsString, bool Castle)
        {
            int[,] TableS = new int[8, 8];
            ...
            lock (O)
            {
                ...
                {
                    Order = ord;
                    ElephantThinkingChess(DummyOrder, DummyCurrentOrder, TableS, ii, jj, DoEnemySelf, PenRegStrore, EnemyCheckMateActionsString, i, j, Castle
            /*    , ref HuristicAttackValue
        , ref HuristicMovementValue
        , ref HuristicSelfSupportedValue
        , ref HuristicObjectDangourCheckMateValue
       , ref HuristicKillerValue
        ...
        public void ThinkingElephant(int ord, int ii, int jj, int DummyOrder, int DummyCurrentOrder, bool DoEnemySelf, bool PenRegStrore, bool EnemyCheckMateActionsString, bool Castle)
        {
                ...
                Parallel.For(-7, 8, i =>
            {
                ...
                lock (O)
                {
                    ...
                    int j = i + jj - ii;
                    if (Scop(ii, jj, i, j, 2))
                        ThinkingElephantBase(ord, ii, jj, i, j, DummyOrder, DummyCurrentOrder, DoEnemySelf, PenRegStrore, EnemyCheckMateActionsString, Castle);
                    ThinkingAtRun = false;
                }
            });
                //==================
        ...
        public void ThinkingHourseOne(int ord, int ii, int jj, int DummyOrder, int DummyCurrentOrder, bool DoEnemySelf, bool PenRegStrore, bool EnemyCheckMateActionsString, bool Castle)
        {
            ...
            lock (O)
            {
                ...
                if (Scop(ii, jj, ii + 2, jj + 1, 3))
                    HourseThinkingChess(DummyOrder, DummyCurrentOrder, TableS, ii, jj, DoEnemySelf, PenRegStrore, EnemyCheckMateActionsString, ii + 2, jj + 1, Castle
    /*    , ref HuristicAttackValue
    , ref HuristicMovementValue
    , ref HuristicSelfSupportedValue
    , ref HuristicObjectDangourCheckMateValue
...
, ref HeuristicFromCenter*/
        ...
        public void ThinkingHourseTwo(int ord, int ii, int jj, int DummyOrder, int DummyCurrentOrder, bool DoEnemySelf, bool PenRegStrore, bool EnemyCheckMateActionsString, bool Castle)
        {
            int[,] TableS = new int[8, 8];
...
, ref HeuristicFromCenter*/);
        ...
        public void ThinkingHourseThree(int ord, int ii, int jj, int DummyOrder, int DummyCurrentOrder, bool DoEnemySelf, bool PenRegStrore, bool EnemyCheckMateActionsString, bool Castle)
        {
            int[,] TableS = new int[8, 8];
    ...
    , ref HeuristicFromCenter*/);
        ...
        public void ThinkingHourseFour(int ord, int ii, int jj, int DummyOrder, int DummyCurrentOrder, bool DoEnemySelf, bool PenRegStrore, bool EnemyCheckMateActionsString, bool Castle)
        {
            int[,] TableS = new int[8, 8];
...
, ref HeuristicFromCenter*/);
        ...
        public void ThinkingHourseFive(int ord, int ii, int jj, int DummyOrder, int DummyCurrentOrder, bool DoEnemySelf, bool PenRegStrore, bool EnemyCheckMateActionsString, bool Castle)
        {
            int[,] TableS = new int[8, 8];
            ...
            lock (O)
            {
                ...
                if (Scop(ii, jj, ii + 1, jj + 2, 3))
                    HourseThinkingChess(DummyOrder, DummyCurrentOrder, TableS, ii, jj, DoEnemySelf, PenRegStrore, EnemyCheckMateActionsString, ii + 1, jj + 2, Castle
    /*, ref HuristicAttackValue
    , ref HuristicMovementValue
    , ref HuristicSelfSupportedValue
    , ref HuristicObjectDangourCheckMateValue
    ...
    , ref HeuristicFromCenter*/);
        ...
        public void ThinkingHourseSix(int ord, int ii, int jj, int DummyOrder, int DummyCurrentOrder, bool DoEnemySelf, bool PenRegStrore, bool EnemyCheckMateActionsString, bool Castle)
        {
            int[,] TableS = new int[8, 8];
    ...
    , ref HeuristicFromCenter*/);
        ...
        public void ThinkingHourseSeven(int ord, int ii, int jj, int DummyOrder, int DummyCurrentOrder, bool DoEnemySelf, bool PenRegStrore, bool EnemyCheckMateActionsString, bool Castle)
        {
            int[,] TableS = new int[8, 8];
    ...
    , ref HeuristicFromCenter*/);
        ...
        public void ThinkingHourseEight(int ord, int ii, int jj, int DummyOrder, int DummyCurrentOrder, bool DoEnemySelf, bool PenRegStrore, bool EnemyCheckMateActionsString, bool Castle)
        {
            int[,] TableS = new int[8, 8];
    ...
    , ref HeuristicFromCenter*/);
        ...
        public void ThinkingHourse(int ord, int ii, int jj, int DummyOrder, int DummyCurrentOrder, bool DoEnemySelf, bool PenRegStrore, bool EnemyCheckMateActionsString, bool Castle)
        {
            Object O = new Object();
            lock (O)
            {
        ...
        public void ThinkingCastleOne(int ord, int ii, int jj, int DummyOrder, int DummyCurrentOrder, bool DoEnemySelf, bool PenRegStrore, bool EnemyCheckMateActionsString, bool Castle)
        {
                ...
                Parallel.For(0, 8, i =>
            {
                ...
                lock (O)
                {
                    ...
                    {
                        Order = ord;
                        CastlesThinkingChess(DummyOrder, DummyCurrentOrder, TableS, ii, jj, DoEnemySelf, PenRegStrore, EnemyCheckMateActionsString, i, j, Castle
    /*, ref HuristicAttackValue
    , ref HuristicMovementValue
    , ref HuristicSelfSupportedValue
    , ref HuristicObjectDangourCheckMateValue
    ...
    , ref HeuristicFromCenter*/);
        ...
        public void ThinkingCastleTow(int ord, int ii, int jj, int DummyOrder, int DummyCurrentOrder, bool DoEnemySelf, bool PenRegStrore, bool EnemyCheckMateActionsString, bool Castle)
        {  //==================
            Object O1 = new Object();
            lock (O1)
            {
    ...
    , ref HeuristicFromCenter*/);
        ...
        public void ThinkingCastle(int ord, int ii, int jj, int DummyOrder, int DummyCurrentOrder, bool DoEnemySelf, bool PenRegStrore, bool EnemyCheckMateActionsString, bool Castle)
        {

            Object O = new Object();
            lock (O)
            {
                ThinkingCastleOne(ord, ii, jj, DummyOrder, DummyCurrentOrder, DoEnemySelf, PenRegStrore, EnemyCheckMateActionsString, Castle);
                ThinkingCastleTow(ord, ii, jj, DummyOrder, DummyCurrentOrder, DoEnemySelf, PenRegStrore, EnemyCheckMateActionsString, Castle);
            }

        }
        public void ThinkingMinisterBase(int ord, int ii, int jj, int i, int j, int DummyOrder, int DummyCurrentOrder, bool DoEnemySelf, bool PenRegStrore, bool EnemyCheckMateActionsString, bool Castle)
        {
            ...
            lock (O)
            {
                ...
                {
                    Order = ord;
                    MinisterThinkingChess(DummyOrder, DummyCurrentOrder, TableS, ii, jj, DoEnemySelf, PenRegStrore, EnemyCheckMateActionsString, i, j, Castle
    /*, ref HuristicAttackValue
    , ref HuristicMovementValue
    , ref HuristicSelfSupportedValue
    , ref HuristicObjectDangourCheckMateValue
    ...
    , ref HeuristicFromCenter*/
        ...
        public void ThinkingMinister(int ord, int ii, int jj, int DummyOrder, int DummyCurrentOrder, bool DoEnemySelf, bool PenRegStrore, bool EnemyCheckMateActionsString, bool Castle)
        {
            ...
            Parallel.For(0, 8, i =>
            {
                Parallel.For(0, 8, j =>
                {
                    ...
                    lock (O)
                    {
                      ...
                      ThinkingMinisterBase(ord, ii, jj, i, j, DummyOrder, DummyCurrentOrder, DoEnemySelf, PenRegStrore, EnemyCheckMateActionsString, Castle);
                        ThinkingAtRun = false;
                    }
              });
          });
        }
        public void ThinkingCastleGray(int ord, int ii, int jj, int DummyOrder, int DummyCurrentOrder, bool DoEnemySelf, bool PenRegStrore, bool EnemyCheckMateActionsString, bool Castle)
        {
            Object O = new Object();
            lock (O)
            {
                for (int i = ii - 2; i < ii + 2; i++)
                {
                    ...
                    {
                        CastleThinkingBrown(DummyOrder, DummyCurrentOrder, TableS, ii, jj, DoEnemySelf, PenRegStrore, EnemyCheckMateActionsString, i, jj, Castle
    /*, ref HuristicAttackValue
    , ref HuristicMovementValue
    , ref HuristicSelfSupportedValue
    , ref HuristicObjectDangourCheckMateValue
    ...
    , ref HeuristicFromCenter*/);
        ...
        public void ThinkingCastleBrown(int ord, int ii, int jj, int DummyOrder, int DummyCurrentOrder, bool DoEnemySelf, bool PenRegStrore, bool EnemyCheckMateActionsString, bool Castle)
        {
            Object O = new Object();
            lock (O)
            {
                for (int i = ii - 2; i < ii + 2; i++)
                {
                    ...
                    {
                        CastleThinkingGray(DummyOrder, DummyCurrentOrder, TableS, ii, jj, DoEnemySelf, PenRegStrore, EnemyCheckMateActionsString, i, jj, Castle
    /*, ref HuristicAttackValue
    , ref HuristicMovementValue
    , ref HuristicSelfSupportedValue
    , ref HuristicObjectDangourCheckMateValue
    ...
    , ref HeuristicFromCenter*/);
        ...
        public void ThinkingKing(int ord, int ii, int jj, int DummyOrder, int DummyCurrentOrder, bool DoEnemySelf, bool PenRegStrore, bool EnemyCheckMateActionsString, bool Castle, ref ChessRules AAA)
        {
            int[,] TableS = new int[8, 8];
            Object O = new Object();
            lock (O)
            {
                for (int i = ii - 1; i <= ii + 1; i++)
                    for (int j = jj - 1; j <= jj + 1; j++)
                    {
                        ...
                        {
                            Order = ord;
                            KingThinkingChess(DummyOrder, DummyCurrentOrder, TableS, ii, jj, DoEnemySelf, PenRegStrore, EnemyCheckMateActionsString, i, j, Castle, AAA
    /*, ref HuristicAttackValue
    , ref HuristicMovementValue
    , ref HuristicSelfSupportedValue
    , ref HuristicObjectDangourCheckMateValue
    ...
    , ref HeuristicFromCenter*/
        ...
        public void Thinking()
        {
            ...
            lock (O)
            {
                ...
                //For root take all Sppurt Count Separatly.
                /*if (CurrentAStarGredyMax == 0)
                {
                    int SuppportCount = 0;
                    for (int ij = 0; ij < 8; ij++)
                        for (int ji = 0; ji < 8; ji++)
                        {
                            ...
                            SuppportCount += SupporterCount(TableS, 1, Color.Gray, ij, ji);
                        }
                    AllDraw.SuppportCountStaticGray = SuppportCount;
                    ...
                    for (int ij = 0; ij < 8; ij++)
                        for (int ji = 0; ji < 8; ji++)
                        {
                            ...
                            SuppportCount += SupporterCount(TableS, -1, Color.Brown, ij, ji);
                        }
                    AllDraw.SuppportCountStaticBrown = SuppportCount;
                }*/

                {
                    ...
                    //for (int i = 0; i < 8; i++)
                    {
                        //  for (int j = 0; j < 8; j++)
                        {
                            ...
                            //CurrentRow = i;
                            //CurrentColumn = j;
                            //SelfCheckMateActionsString = false;
                            ...
                            /*
                            ///Deterimine Current Table Order and int.
                            ...
                            ChessRules AAA = new ChessRules(CurrentAStarGredyMax, MovementsAStarGreedyHuristicFoundT, IgnoreSelfObjectsT, UsePenaltyRegardMechnisamT, BestMovmentsT, PredictHuristicT, OnlySelfT, AStarGreedyHuristicT, ArrangmentsChanged, TableS[ii, jj], TableS, Order, Row, Column);
                            ...
                            try
                            {
                                if (Kind == 7)
                                {
                                    ThinkingCastleBrown(ord, ii, jj, DummyOrder, DummyCurrentOrder, DoEnemySelf, PenRegStrore, EnemyCheckMateActionsString, Castle);
                                }
                                else
                                    if (Kind == -7)
                                {
                                    ThinkingCastleGray(ord, ii, jj, DummyOrder, DummyCurrentOrder, DoEnemySelf, PenRegStrore, EnemyCheckMateActionsString, Castle);
                                }
                                else
                                        if (System.Math.Abs(Kind) == 1)///For Soldier Thinking
                                {
                                    ThinkingSoldier(ord, ii, jj, DummyOrder, DummyCurrentOrder, DoEnemySelf, PenRegStrore, EnemyCheckMateActionsString, Castle);
                                }
                                else
                                            if (System.Math.Abs(Kind) == 2)///For Elephant Thinking
                                {
                                    ThinkingElephant(ord, ii, jj, DummyOrder, DummyCurrentOrder, DoEnemySelf, PenRegStrore, EnemyCheckMateActionsString, Castle);
                                }
                                ///Else for Hourse Thinking.
                                else
                                                if (System.Math.Abs(Kind) == 3)///For Hourse Thinking
                                {
                                    ThinkingHourse(ord, ii, jj, DummyOrder, DummyCurrentOrder, DoEnemySelf, PenRegStrore, EnemyCheckMateActionsString, Castle);
                                }
                                ///Else For Castles Thinking.
                                else
                                                    if (System.Math.Abs(Kind) == 4)///For Castle Thinking
                                {
                                    ThinkingCastle(ord, ii, jj, DummyOrder, DummyCurrentOrder, DoEnemySelf, PenRegStrore, EnemyCheckMateActionsString, Castle);
                                }
                                ///Else for Minister Thinkings.
                                else
                                                        if (System.Math.Abs(Kind) == 5)///For Minister Thinking
                                {
                                    ThinkingMinister(ord, ii, jj, DummyOrder, DummyCurrentOrder, DoEnemySelf, PenRegStrore, EnemyCheckMateActionsString, Castle);
                                }
                                ///Else For Kings Thinkings.
                                else
                                                            if (System.Math.Abs(Kind) == 6)///For King Thinking
                                {
                                    ThinkingKing(ord, ii, jj, DummyOrder, DummyCurrentOrder, DoEnemySelf, PenRegStrore, EnemyCheckMateActionsString, Castle, ref AAA);
        ...
        int ObjectValueCalculator(int[,] Table, int Order, int ii, int jj)
        {
            int Val = 0;
            //if (BeginArragmentsOfOrderFinished(Tabl, Order))
            {

                ChessRules A = new ChessRules(CurrentAStarGredyMax, MovementsAStarGreedyHuristicFoundT, IgnoreSelfObjectsT, UsePenaltyRegardMechnisamT, BestMovmentsT, PredictHuristicT, OnlySelfT, AStarGreedyHuristicT, ArrangmentsChanged, Table[ii, jj], Table, Order, ii, jj);
                Color a = Color.Gray;
                Color aa = Color.Gray;
                if (Order == -1)
                    a = Color.Brown;
              ...
              Parallel.For(0, 8, Column =>
              {
                  Parallel.For(0, 8, iii =>
                  {
                      Parallel.For(0, 8, jjj =>
                      {
                          //if (Table[Row, Column] == 0 || Table[iii, jjj] == 0)
                          //return;
                          /*int[,] Tabl = new int[8, 8];
                          Parallel.For(0, 8, i =>
                            Parallel.For(0, 8, j =>
                          ...
                          ChessRules AA = new ChessRules(CurrentAStarGredyMax, MovementsAStarGreedyHuristicFoundT, IgnoreSelfObjectsT, UsePenaltyRegardMechnisamT, BestMovmentsT, PredictHuristicT, OnlySelfT, AStarGreedyHuristicT, ArrangmentsChanged, Tabl[Row, Column], Tabl, Order * -1, Row, Column);
                          */
                          /*if (System.Math.Abs(Tabl[ii, jj]) == 1)
                          {
                              if (Scop(ii, jj, Row, Column, 1))
                              {
                                  if (A.Rules(ii, jj, Row, Column, a, Order))
                                      Val++;
                              }
                              if (Scop(Row, Column, ii, jj, System.Math.Abs(Table[Row, Column])) && (Table[Row, Column] != 0) && (Table[ii, jj] != 0))
                              {

                                  if (Attack(Tabl, Row, Column, ii, jj, aa, Order * -1))
                                      Val--;
                                  if (Support(Tabl, Row, Column, ii, jj, a, Order))
                                      Val++;
                              }
                          }
                          else
                          ...
                          lock (O)
                          {
                              if (Scop(Row, Column, iii, jjj, System.Math.Abs(Table[Row, Column])))
                              {
                                  ...
                                  {
                                      A = new ChessRules(CurrentAStarGredyMax, MovementsAStarGreedyHuristicFoundT, IgnoreSelfObjectsT, UsePenaltyRegardMechnisamT, BestMovmentsT, PredictHuristicT, OnlySelfT, AStarGreedyHuristicT, ArrangmentsChanged, Table[Row, Column], Table, Order, Row, Column);
                                      if (A.Rules(Row, Column, iii, jjj, a, Order))
                                          Val++;
                                  }
                                  else
                                  if (SignEqualOrEmptyEnemy(Table[Row, Column], Table[iii, jjj], Order))
                                  {
                                      A = new ChessRules(CurrentAStarGredyMax, MovementsAStarGreedyHuristicFoundT, IgnoreSelfObjectsT, UsePenaltyRegardMechnisamT, BestMovmentsT, PredictHuristicT, OnlySelfT, AStarGreedyHuristicT, ArrangmentsChanged, Table[Row, Column], Table, Order, Row, Column);
                                      if (A.Rules(Row, Column, iii, jjj, a, Order))
                                          Val--;
                              ...
                              if (Scop(Row, Column, iii, jjj, System.Math.Abs(Table[Row, Column])) && (Table[Row, Column] != 0) && (Table[iii, jjj] != 0))
                              {
                                  ...
                                  if (Order == AllDraw.OrderPlate)
                                  {
                                      if (SignNotEqual(Table[Row, Column], Table[iii, jjj]))
                                      {
                                      ...
                                      if (SignEqual(Table[Row, Column], Table[iii, jjj]))
                                      {
                                          ...
                                          if (Support(Table, Row, Column, iii, jjj, a, Order))
                                              Val++;
                                      }
                                      else
                                      if (SignNotEqual(Table[Row, Column], Table[iii, jjj]))
                                      {
                                          ...
                                          if (Attack(Table, Row, Column, iii, jjj, a, Order))
                                              Val++;
                                      }
                                      else
                                      ...
                                      if (SignEqual(Table[Row, Column], Table[iii, jjj]))
                                      {
                                          if (Support(Table, Row, Column, iii, jjj, aa, Order * -1))
                                              Val--;
                                      }
                                      else
                                          return;
