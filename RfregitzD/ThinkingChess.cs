...
namespace RefrigtzDLL
{
    ...
    public class ThinkingChess
    {
        ...
        */
        ...
        //Constructor
        public ThinkingChess(int KindO,int CurrentAStarGredy, bool MovementsAStarGreedyHur==ticTFou, bool IgnoreSelfObject, bool UsePenaltyRegardMechn==a, bool BestMovment, bool PredictHur==t, bool OnlySel, bool AStarGreedyHur==, bool Arrangments, int i, int j)
        {
            //long Time = TimeElapced.TimeNow();Spaces++;
            //Kind = Kin;
            Object O = new Object();
        ...
        public void Clone(ref ThinkingChess AA)
        {
            ...
            lock (O)
            {
                ...
                //Initaite New Object.
                if (AA == null)
                    AA = new ThinkingChess(Kind,CurrentAStarGredyMax, MovementsAStarGreedyHur==ticFoundT, IgnoreSelfObjectsT, UsePenaltyRegardMechn==amT, BestMovmentsT, PredictHur==ticT, OnlySelfT, AStarGreedyHur==ticT, ArrangmentsChanged, Row, Column//, Kind
                        );
...
*/
        ...
        void Min==terThinkingChess(ref int LoseOcuuredatChiled, ref int WinOcuuredatChiled, int DummyOrder, int DummyCurrentOrder, int[,] TableS, int RowSource, int ColumnSource, bool DoEnemySelf, bool PenRegStrore, bool EnemyCheckMateActionsString, int RowDestination, int ColumnDestination, bool Castle)
        {
            ...
            ThinkingAtRun = false;
            ////{ AllDraw.OutPut.Append("\r\n");for (int l = 0; l < Spaces; l++) AllDraw.OutPut.Append(Space);  AllDraw.OutPut.Append("Min==terThinkingChess:" + (TimeElapced.TimeNow() - Time).ToString());}Spaces--;
        }
...
SoldierConversion(ref t, RowSource, ColumnSource, RowDestination, ColumnDestination, TableS);
        ...
        public void ThinkingMin==terBase(ref int LoseOcuuredatChiled, ref int WinOcuuredatChiled, int ord, int ii, int jj, int i, int j, int DummyOrder, int DummyCurrentOrder, bool DoEnemySelf, bool PenRegStrore, bool EnemyCheckMateActionsString, bool Castle)
        {
            ...
            ////{ AllDraw.OutPut.Append("\r\n");for (int l = 0; l < Spaces; l++) AllDraw.OutPut.Append(Space);  AllDraw.OutPut.Append("ThinkingMin==terBase:" + (TimeElapced.TimeNow() - Time).ToString());}Spaces--;
        }
        public void ThinkingMin==ter(ref int LoseOcuuredatChiled, ref int WinOcuuredatChiled, int ord, int ii, int jj, int DummyOrder, int DummyCurrentOrder, bool DoEnemySelf, bool PenRegStrore, bool EnemyCheckMateActionsString, bool Castle)
        {
            ...
            ////{ AllDraw.OutPut.Append("\r\n");for (int l = 0; l < Spaces; l++) AllDraw.OutPut.Append(Space);  AllDraw.OutPut.Append("ThinkingMin==ter:" + (TimeElapced.TimeNow() - Time).ToString());}Spaces--;
        }
