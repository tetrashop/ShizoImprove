...
namespace RefrigtzDLL
{
	...
	public:
		...
		//Constructpor 2.
		DrawHourse(int CurrentAStarGredy, bool MovementsAStarGreedyHuristicTFou, bool IgnoreSelfObject, bool UsePenaltyRegardMechnisa, bool BestMovment, bool PredictHurist, bool OnlySel, bool AStarGreedyHuris, bool Arrangments, float i, float j, int a, int **Tab, int Ord, bool TB, int Cur); //, AllDraw:: THIS

		void Clone(DrawHourse AA);

		//Cloen a Copy.
		//void Clone(DrawHourse AA); //,  AllDraw:: THIS
