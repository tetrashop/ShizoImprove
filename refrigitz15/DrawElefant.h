...
//ORIGINAL LINE: [Serializable] public class DrawElefant
	...
	public:
		...
		//Constructor 2.
		DrawElefant(int CurrentAStarGredy, bool MovementsAStarGreedyHuristicTFou, bool IgnoreSelfObject, bool UsePenaltyRegardMechnisa, bool BestMovment, bool PredictHurist, bool OnlySel, bool AStarGreedyHuris, bool Arrangments, float i, float j, int a, int **Tab, int Ord, bool TB, int Cur); //, AllDraw:: THIS


		void Clone(DrawElefant AA);

		//Clone a Copy.
		//void Clone(DrawElefant AA); //,  AllDraw:: THIS
