...
namespace Ellipse
{
    class EllipsAroundFormula
    {
        ...
        public EllipsAroundFormula(double a,double b,double c)
        {
            ...
            Laround1 = Math.Sqrt((2 * p) * (-1 * Math.Log(1 + e * Math.Cos(u), Math.E) * teta - e * u * Math.Cos(u) - 0.5 * Math.Sin(u) + (e / 2) * Math.Pow(Math.Log(1 + e * Math.Cos(u)), 2)) + Math.Pow(r, 2) + teta);
            ...
            Paround0 = 2 * p * (u * Math.Log(1 + e * Math.Cos(u), Math.E)
                  ...
                  + 0.5 * Math.Pow(r, 2))
                  + r + teta;*/
            Laround0 = Math.Sqrt((2 * p) * (-1 * Math.Log(1 + e * Math.Cos(u), Math.E) * teta - e * u * Math.Cos(u) - 0.5 * Math.Sin(u) + (e / 2) * Math.Pow(Math.Log(1 + e * Math.Cos(u)), 2)) + Math.Pow(r, 2) + teta);
 ...
 */
            ...
            //Second Integral priciple first parameters 
            Paround1 = Math.Sqrt((2 * p) * (-1 * Math.Log(1 + e * Math.Cos(u), Math.E) * teta - e * u * Math.Cos(u) - 0.5 * Math.Sin(u) + (e / 2) * Math.Pow(Math.Log(1 + e * Math.Cos(u)), 2)) + Math.Pow(r, 2) + teta);
            ...
            //Second Integral priciple first parameters 
            Paround0 = Math.Sqrt((2 * p) * (-1 * Math.Log(1 + e * Math.Cos(u), Math.E) * teta - e * u * Math.Cos(u) - 0.5 * Math.Sin(u) + (e / 2) * Math.Pow(Math.Log(1 + e * Math.Cos(u)), 2)) + Math.Pow(r, 2) + teta);
