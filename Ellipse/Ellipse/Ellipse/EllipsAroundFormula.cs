...
namespace Ellipse
{
    class EllipsAroundFormula
    {
        ...
        public EllipsAroundFormula(double a,double b,double c)
        {
            ...
            Laround1 = Math.Sqrt((2 * p) * (-1 * Math.Log(1 + e * Math.Cos(u), Math.E) * teta - e * teta * Math.Cos(u) - 0.5 * Math.Sin(u) + (e / 2) * Math.Log(Math.Pow(1 + e * Math.Cos(u), 2), Math.E) +0.5*Math.Pow(r, 2) + teta));
            /*  Laround1 = (2 * p) * (teta * Math.Log(1 + e * Math.Cos(u), Math.E) + (2 / Math.Sqrt(1 - Math.Pow(e, 2))) * teta * Math.Sin(u) * Math.Atan(Math.Sqrt((1 - e) / (1 + e)) * Math.Tan(teta / 2)) + ((2 * e) / (Math.Sqrt(1 - Math.Pow(e, 2)))) * Math.Cos(u) * Math.Atan(Math.Sqrt((1 - e) / (1 + e)) * Math.Tan(teta / 2)) - (2 / (1 - ((1 - e) / (1 + e)))) * ((2 * e) / (Math.Sqrt(1 - Math.Pow(e, 2)))) * teta + Math.Sqrt((1 - e) / (1 + e)) * ((2 * e) / (Math.Sqrt(1 - Math.Pow(e, 2)))) * ((2 * (1 + ((1 - e) / (1 + e)))) / (1 - ((1 - e) / (1 + e)))) * Math.Atan(Math.Sqrt((1 - e) / (1 + e)) * Math.Tan(teta / 2)) - ((2 * e) / (Math.Sqrt(1 - Math.Pow(e, 2)))) * ((Math.Pow(Math.Sqrt((1 - e) / (1 + e)), 5) - 5 * Math.Sqrt((1 - e) / (1 + e))) / ((1 - (Math.Pow(Math.Sqrt((1 - e) / (1 + e)), 4))) * (Math.Pow(Math.Sqrt((1 - e) / (1 + e)), 2) + 1))) * Math.Pow(teta, 2) * Math.Sin(u) - (((2 * e) / (Math.Sin(1 - Math.Pow(e, 2)))) * ((10 * (Math.Sqrt((1 - e) / (1 + e))) - (2 * Math.Pow((Math.Sqrt((1 - e) / (1 + e))), 5))) / ((1 - (Math.Pow(Math.Sqrt((1 - e) / (1 + e)), 4))) * (Math.Pow(Math.Sqrt((1 - e) / (1 + e)), 2) + 1)))) * Math.Cos(u) - ((2 * e) / Math.Sqrt(1 - Math.Pow(e, 2))) * (((4 * (Math.Sqrt((1 - e) / (1 + e))) - 4 * Math.Pow((Math.Sqrt((1 - e) / (1 + e))), 3))) / (Math.Pow(1 - (Math.Pow((Math.Sqrt((1 - e) / (1 + e))), 2)), 2) * Math.Pow(1 + (Math.Pow((Math.Sqrt((1 - e) / (1 + e))), 2)), 2))) * Math.Pow(teta, 2) * Math.Atan(Math.Sqrt((1 - e) / (1 + e)) * Math.Tan(teta / 2)) + ((2 * e) / (Math.Sqrt(1 - Math.Pow(e, 2)) * ((8 - (12 * (Math.Pow(Math.Sqrt((1 - e) / (1 + e)), 2)))) / (3 * (Math.Pow(1 - (Math.Pow(Math.Sqrt((1 - e) / (1 + e)), 2)), 2)) * ((1 + (Math.Pow(Math.Sqrt((1 - e) / (1 + e)), 2)))))))) * Math.Pow(teta, 3) + teta) + Math.Pow(p / (1 + e * Math.Cos(u)), 2) + p / (1 + e * Math.Cos(u));
                      Paround1 = 2 * p * (u * Math.Log(1 + e * Math.Cos(u), Math.E)
                          + (2 / Math.Sqrt(1 - Math.Pow(e, 2))) * b * teta * Math.Sin(u) * Math.Atan(Math.Sqrt((1 - e) / (1 + e)) * Math.Tan(u / 2))
                          + ((2 * e) / (Math.Sqrt(1 - Math.Pow(e, 2)))) * Math.Cos(u) * Math.Atan(Math.Sqrt((1 - e) / (1 + e)) * Math.Tan(u / 2))
                          - (2 / (1 - ((1 - e) / (1 + e)))) * ((2 * e) / (Math.Sqrt(1 - Math.Pow(e, 2)))) * teta
            ...
            /*around0 = (2 * p) * (teta * Math.Log(1 + e * Math.Cos(u), Math.E) + (2 / Math.Sqrt(1 - Math.Pow(e, 2))) * teta * Math.Sin(u) * Math.Atan(Math.Sqrt((1 - e) / (1 + e)) * Math.Tan(teta / 2)) + ((2 * e) / (Math.Sqrt(1 - Math.Pow(e, 2)))) * Math.Cos(u) * Math.Atan(Math.Sqrt((1 - e) / (1 + e)) * Math.Tan(teta / 2)) - (2 / (1 - ((1 - e) / (1 + e)))) * ((2 * e) / (Math.Sqrt(1 - Math.Pow(e, 2)))) * teta + Math.Sqrt((1 - e) / (1 + e)) * ((2 * e) / (Math.Sqrt(1 - Math.Pow(e, 2)))) * ((2 * (1 + ((1 - e) / (1 + e)))) / (1 - ((1 - e) / (1 + e)))) * Math.Atan(Math.Sqrt((1 - e) / (1 + e)) * Math.Tan(teta / 2)) - ((2 * e) / (Math.Sqrt(1 - Math.Pow(e, 2)))) * ((Math.Pow(Math.Sqrt((1 - e) / (1 + e)), 5) - 5 * Math.Sqrt((1 - e) / (1 + e))) / ((1 - (Math.Pow(Math.Sqrt((1 - e) / (1 + e)), 4))) * (Math.Pow(Math.Sqrt((1 - e) / (1 + e)), 2) + 1))) * Math.Pow(teta, 2) * Math.Sin(u) - (((2 * e) / (Math.Sin(1 - Math.Pow(e, 2)))) * ((10 * (Math.Sqrt((1 - e) / (1 + e))) - (2 * Math.Pow((Math.Sqrt((1 - e) / (1 + e))), 5))) / ((1 - (Math.Pow(Math.Sqrt((1 - e) / (1 + e)), 4))) * (Math.Pow(Math.Sqrt((1 - e) / (1 + e)), 2) + 1)))) * Math.Cos(u) - ((2 * e) / Math.Sqrt(1 - Math.Pow(e, 2))) * (((4 * (Math.Sqrt((1 - e) / (1 + e))) - 4 * Math.Pow((Math.Sqrt((1 - e) / (1 + e))), 3))) / (Math.Pow(1 - (Math.Pow((Math.Sqrt((1 - e) / (1 + e))), 2)), 2) * Math.Pow(1 + (Math.Pow((Math.Sqrt((1 - e) / (1 + e))), 2)), 2))) * Math.Pow(teta, 2) * Math.Atan(Math.Sqrt((1 - e) / (1 + e)) * Math.Tan(teta / 2)) + ((2 * e) / (Math.Sqrt(1 - Math.Pow(e, 2)) * ((8 - (12 * (Math.Pow(Math.Sqrt((1 - e) / (1 + e)), 2)))) / (3 * (Math.Pow(1 - (Math.Pow(Math.Sqrt((1 - e) / (1 + e)), 2)), 2)) * ((1 + (Math.Pow(Math.Sqrt((1 - e) / (1 + e)), 2)))))))) * Math.Pow(teta, 3) + teta) + Math.Pow(p / (1 + e * Math.Cos(u)), 2) + p / (1 + e * Math.Cos(u));
                   Laround0 = 2 * p * (u * Math.Log(1 + e * Math.Cos(u), Math.E)
                         ...
                         + 0.5 * Math.Pow(r, 2))
                         + r + teta;*/
            Laround0 = Math.Sqrt((2 * p) * (-1 * Math.Log(1 + e * Math.Cos(u), Math.E) * teta - e * teta * Math.Cos(u) - 0.5 * Math.Sin(u) + (e / 2) * Math.Log(Math.Pow(1 + e * Math.Cos(u), 2), Math.E) +0.5*Math.Pow(r, 2) + teta));
 ...
 */
            ...
            //Second Integral priciple first parameters 
            Paround1 = Math.Sqrt((2 * p) * (-1 * Math.Log(1 + e * Math.Cos(u), Math.E) * teta - e * teta * Math.Cos(u) - 0.5 * Math.Sin(u) + (e / 2) * Math.Log(Math.Pow(1 + e * Math.Cos(u), 2), Math.E) +0.5*Math.Pow(r, 2) + teta));

            u =0;
            teta = u;// * (180 / Math.PI);
            r = (p) / (1 + e * Math.Cos(u));
            //Second Integral priciple first parameters 
            Paround0 = Math.Sqrt((2 * p) * (-1 * Math.Log(1 + e * Math.Cos(u), Math.E) * teta - e * teta * Math.Cos(u) - 0.5 * Math.Sin(u) + (e / 2) * Math.Log(Math.Pow(1 + e * Math.Cos(u), 2), Math.E) +0.5*Math.Pow(r, 2) + teta));
