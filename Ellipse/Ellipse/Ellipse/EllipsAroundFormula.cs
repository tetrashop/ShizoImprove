...
namespace Ellipse
{
    class EllipsAroundFormula
    {
        ...
        END:*/
            ...
            Laround1 = (2 * p) * (-1 * Math.Log(1 + e * Math.Cos(u), Math.E) - e * u * Math.Cos(u) - 0.5 * Math.Sin(u) + (e / 2) * Math.Log(Math.Pow(1 + e * Math.Cos(u), 2))) + Math.Pow(r, 2) + teta;
            ...
            Paround0 = 2 * p * (u * Math.Log(1 + e * Math.Cos(u), Math.E)
                  ...
                  + 0.5 * Math.Pow(r, 2))
                  + r + teta;*/
            Laround0 = (2 * p) * (-1 * Math.Log(1 + e * Math.Cos(u), Math.E) - e * u * Math.Cos(u) - 0.5 * Math.Sin(u) + (e / 2) * Math.Log(Math.Pow(1 + e * Math.Cos(u), 2))) + Math.Pow(r, 2) + teta;
 ...
 */
            ...
            //Second Integral priciple first parameters 
            Paround1 = (2 * p) * (-1 * Math.Log(1 + e * Math.Cos(u), Math.E) - e * u * Math.Cos(u) - 0.5 * Math.Sin(u) + (e / 2) * Math.Log(Math.Pow(1 + e * Math.Cos(u), 2))) + Math.Pow(r, 2) + teta;
            ...
            //Second Integral priciple first parameters 
            Paround0 = (2 * p) * (-1 * Math.Log(1 + e * Math.Cos(u), Math.E) - e * u * Math.Cos(u) - 0.5 * Math.Sin(u) + (e / 2) * Math.Log(Math.Pow(1 + e * Math.Cos(u), 2))) + Math.Pow(r, 2) + teta;
