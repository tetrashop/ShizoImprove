    ...
    public partial class FormTryCatchRemover : Form
    {
        ...
        private void buttonCodeComment_Click(object sender, EventArgs e)
        {
            ...
            do
            {
                ...
                if (Contain[i].IndexOf("//") != -1 && Contain[i].IndexOf("do") != -1 && Contain[i].IndexOf("/r") != -1)
                {
                    int ii = Contain[i].IndexOf("//");
                    int jj = Contain[i].Length;
                    if (jj > ii)
                ...
                if (Contain[i].IndexOf("//") != -1 && Contain[i].IndexOf("Parallel") != -1 && Contain[i].IndexOf("/r") != -1)
                {
                    int ii = Contain[i].IndexOf("//");
                    int jj = Contain[i].Length;
                    if (jj > ii)
                ...
                if (Contain[i].IndexOf("//") != -1 && Contain[i].IndexOf("var") != -1 && Contain[i].IndexOf("/r") != -1)
                {
                    int ii = Contain[i].IndexOf("//");
                    int jj = Contain[i].Length;
                    if (jj > ii)
                ...
                if (Contain[i].IndexOf("//") != -1 && Contain[i].IndexOf("int") != -1 && Contain[i].IndexOf("/r") != -1)
                {
                    int ii = Contain[i].IndexOf("//");
                    int jj = Contain[i].Length;
                    if (jj > ii)
                ...
                if (Contain[i].IndexOf("//") != -1 && Contain[i].IndexOf("float") != -1 && Contain[i].IndexOf("/r") != -1)
                {
                    int ii = Contain[i].IndexOf("//");
                    int jj = Contain[i].Length;
                    if (jj > ii)
