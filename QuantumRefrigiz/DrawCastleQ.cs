...
#pragma warning restore CS0414 // The field 'DrawCastleQ.Spaces' is ASsigned but its value is never used
        ...
        //Constructor 1.
        /*  public DrawCastleQ(int CurrentAStarGredy, bool MovementsAStarGreedyHeuristicTFou, bool IgnoreSelfObject, bool UsePenaltyRegardMechnisa, bool BestMovment, bool PredictHurist, bool OnlySel, bool AStarGreedyHuris, bool Arrangments)
          {
            ...
            )
        {
            ...
            lock (balancelock)
            {
                ...
                for (var ii = 0; ii < AllDraw.CastleMovments; ii++)
                    CastleThinkingQuantum[ii] = new ThinkingQuantumChess(ii, 4, CurrentAStarGredyMax, MovementsAStarGreedyHeuristicFoundT, IgnoreSelfObjectsT, UsePenaltyRegardMechnisamT, BestMovmentsT, PredictHeuristicT, OnlySelfT, AStarGreedyHeuristicT, ArrangmentsChanged, (int)i, (int)j, a, Tab, 16, Ord, TB, Cur, 4, 4);
