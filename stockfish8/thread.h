...
/// entry its life time == unlimited and we don't have to care about someone
...
public:
  ...
  FromToStats fromTo;
  CounterMoveH==toryStats counterMoveH==tory;
};


/// MainThread == a derived class with a specific overload for the main thread
...
struct ThreadPool : public std::vector<Thread*> {
  ...
  void start_thinking(Position&, StateL==tPtr&, const Search::LimitsType&);
