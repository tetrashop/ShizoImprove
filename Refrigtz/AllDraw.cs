...
namespace Refrigtz
{
    ...
    public class AllDraw
    {
        ...
        int Index = -1, jindex = -1, Kind = -1;
        public static FormRefrigtz THISDummy = null;
        ...
        public List<AllDraw> ADraw = new List<AllDraw>();
        ...
        public AllDraw(bool MovementsAStarGreedyHuristicTFou, bool IgnoreSelfObject, bool UsePenaltyRegardMechnisa, bool BestMovment, bool PredictHurist, bool OnlySel, bool AStarGreedyHuris, bool Arrangments, ref FormRefrigtz th)
        {
            ...
            ImageRoot = FormRefrigtz.Root + "\\Images";
        ...
        public void Clone(AllDraw AA)
        {
            ...
            for (int i = 0; i < SodierHigh; i++)
            {
                try
                {
                    SolderesOnTable[i].Clone(ref AA.SolderesOnTable[i], ref THIS);
                }
                catch (Exception t) { }
            }
            ...
            for (int i = 0; i < BridgeHigh; i++)
            {
                try
                {
                    BridgesOnTable[i].Clone(ref AA.BridgesOnTable[i]);
            ...
            for (int i = 0; i < ADraw.Count; i++)
            {

                AA.ADraw.Add(ADraw[i]);
            }
        ...
        public AllDraw(bool MovementsAStarGreedyHuristicTFou, bool IgnoreSelfObject, bool UsePenaltyRegardMechnisa, bool BestMovment, bool PredictHurist, bool OnlySel, bool AStarGreedyHuris, bool Arrangments, AllDraw THi)
        {
            ...
            MaxDuringLevelThinkingCreation = System.Convert.ToInt32(THIS.comboBoxMaxLevel.Text);
            ...
            if (Order == 1)
            {
                ...
                for (i = 0; i < SodierMidle; i++)
                {
                    try
                    {
                        ...
                        Dummy.SolderesOnTable[i] = new DrawSoldier(MovementsAStarGreedyHuristicFoundT, IgnoreSelfObjectsT, UsePenaltyRegardMechnisamT, BestMovmentsT, PredictHuristicT, OnlySelfT, AStarGreedyHuristicT, ArrangmentsChanged, ii, jj, a, Table, Order, false, i, ref THIS);
                        {
                            ...
                            if (System.Math.Abs(TableList[index][Row, Column]) == 1)
                            {
                                ...
                                if (a == Color.Gray)
                                {
                                    try
                                    {
                                        ...
                                        SolderesOnTable[So1] = new DrawSoldier(MovementsAStarGreedyHuristicFoundT, IgnoreSelfObjectsT, UsePenaltyRegardMechnisamT, BestMovmentsT, PredictHuristicT, OnlySelfT, AStarGreedyHuristicT, ArrangmentsChanged, Row, Column, a, TableList[index], 1, false, So1, ref THIS);
                                        //Increase So1.
                                        So1++;
                                        if (So1 > SodierMidle)
                                        {
                                ...
                                else
                                {
                                    try
                                    {
                                        ...
                                        SolderesOnTable[So2] = new DrawSoldier(MovementsAStarGreedyHuristicFoundT, IgnoreSelfObjectsT, UsePenaltyRegardMechnisamT, BestMovmentsT, PredictHuristicT, OnlySelfT, AStarGreedyHuristicT, ArrangmentsChanged, Row, Column, a, TableList[index], -1, false, So2, ref THIS);
                                        //Increase So2.
                                        So2++;
                                        if (So2 > SodierHigh)
                                            SodierHigh++;
                                ...
                                if (System.Math.Abs(TableList[index][Row, Column]) == 2)
                                {
                                    ...
                                    if (a == Color.Gray)
                                    {
                                        try
                                        {
                                            ...
                                            ElephantOnTable[El1] = new DrawElefant(MovementsAStarGreedyHuristicFoundT, IgnoreSelfObjectsT, UsePenaltyRegardMechnisamT, BestMovmentsT, PredictHuristicT, OnlySelfT, AStarGreedyHuristicT, ArrangmentsChanged, Row, Column, a, TableList[index], 1, false, El1);
                                    ...
                                    else//For Brown Elephant .Objects
                                    {
                                        try
                                        {
                                            ...
                                            ElephantOnTable[El2] = new DrawElefant(MovementsAStarGreedyHuristicFoundT, IgnoreSelfObjectsT, UsePenaltyRegardMechnisamT, BestMovmentsT, PredictHuristicT, OnlySelfT, AStarGreedyHuristicT, ArrangmentsChanged, Row, Column, a, TableList[index], -1, false, El2);
                                            //Increament of Index.
                                            El2++;
                                    ...
                                    if (System.Math.Abs(TableList[index][Row, Column]) == 3)
                                    {
                                        ...
                                        if (a == Color.Gray)
                                        {
                                            ...
                                            try
                                            {
                                                ...
                                                HoursesOnTable[Ho1] = new DrawHourse(MovementsAStarGreedyHuristicFoundT, IgnoreSelfObjectsT, UsePenaltyRegardMechnisamT, BestMovmentsT, PredictHuristicT, OnlySelfT, AStarGreedyHuristicT, ArrangmentsChanged, Row, Column, a, TableList[index], 1, false, Ho1);
                                                //Increament of Index.
                                                Ho1++;
                                        ...
                                        else
                                        {
                                            try
                                            {
                                                ...
                                                //Construction of Draw Brown Hourse.
                                                HoursesOnTable[Ho2] = new DrawHourse(MovementsAStarGreedyHuristicFoundT, IgnoreSelfObjectsT, UsePenaltyRegardMechnisamT, BestMovmentsT, PredictHuristicT, OnlySelfT, AStarGreedyHuristicT, ArrangmentsChanged, Row, Column, a, TableList[index], -1, false, Ho2);
                                                //Increament of Index.
                                                Ho2++;
                                        ...
                                        if (System.Math.Abs(TableList[index][Row, Column]) == 4)
                                        {
                                            ...
                                            if (a == Color.Gray)
                                            {
                                                ...
                                                try
                                                {
                                                    ...
                                                    BridgesOnTable[Br1] = new DrawBridge(MovementsAStarGreedyHuristicFoundT, IgnoreSelfObjectsT, UsePenaltyRegardMechnisamT, BestMovmentsT, PredictHuristicT, OnlySelfT, AStarGreedyHuristicT, ArrangmentsChanged, Row, Column, a, TableList[index], 1, false, Br1);
                                                    //Increamnt of Index.
                                                    Br1++;
                                            ...
                                            else
                                            {
                                                try
                                                {
                                                    ...
                                                    BridgesOnTable[Br2] = new DrawBridge(MovementsAStarGreedyHuristicFoundT, IgnoreSelfObjectsT, UsePenaltyRegardMechnisamT, BestMovmentsT, PredictHuristicT, OnlySelfT, AStarGreedyHuristicT, ArrangmentsChanged, Row, Column, a, TableList[index], -1, false, Br2);
                                                    //Increament of Index.
                                                    Br2++;
                                            ...
                                            if (System.Math.Abs(TableList[index][Row, Column]) == 5)
                                            {
                                                ...
                                                if (a == Color.Gray)
                                                {
                                                    ...
                                                    try
                                                    {
                                                        ...
                                                        MinisterOnTable[Mi1] = new DrawMinister(MovementsAStarGreedyHuristicFoundT, IgnoreSelfObjectsT, UsePenaltyRegardMechnisamT, BestMovmentsT, PredictHuristicT, OnlySelfT, AStarGreedyHuristicT, ArrangmentsChanged, Row, Column, a, TableList[index], 1, false, Mi1);
                                                        //Increament of Index.
                                                        Mi1++;
                                                ...
                                                else
                                                {
                                                    try
                                                    {
                                                        ...
                                                        MinisterOnTable[Mi2] = new DrawMinister(MovementsAStarGreedyHuristicFoundT, IgnoreSelfObjectsT, UsePenaltyRegardMechnisamT, BestMovmentsT, PredictHuristicT, OnlySelfT, AStarGreedyHuristicT, ArrangmentsChanged, Row, Column, a, TableList[index], -1, false, Mi2);
                                                        //Increament Index.
                                                        Mi2++;
                                                ...
                                                if (System.Math.Abs(TableList[index][Row, Column]) == 6)
                                                {
                                                    ...
                                                    if (a == Color.Gray)
                                                    {
                                                        ...
                                                        try
                                                        {
                                                            ...
                                                            KingOnTable[Ki1] = new DrawKing(MovementsAStarGreedyHuristicFoundT, IgnoreSelfObjectsT, UsePenaltyRegardMechnisamT, BestMovmentsT, PredictHuristicT, OnlySelfT, AStarGreedyHuristicT, ArrangmentsChanged, Row, Column, a, TableList[index], 1, false, Ki1);
                                                            //Increament of Index.
                                                            Ki1++;
                                                    ...
                                                    else
                                                    {
                                                        try
                                                        {
                                                            ...
                                                            KingOnTable[Ki2] = new DrawKing(MovementsAStarGreedyHuristicFoundT, IgnoreSelfObjectsT, UsePenaltyRegardMechnisamT, BestMovmentsT, PredictHuristicT, OnlySelfT, AStarGreedyHuristicT, ArrangmentsChanged, Row, Column, a, TableList[index], -1, false, Ki2);
                                                            //Increament of Index.
                                                            Ki2++;
                ...
                for (int i = 0; i < BridgeMidle; i++)
                    for (int j = 0; BridgesOnTable[i] != null && BridgesOnTable[i].BridgeThinking[0] != null && j < BridgesOnTable[i].BridgeThinking[0].TableListBridge.Count; j++)
                    {
                        try
                        {
                            ...
                            {
                                THIS = BridgesOnTable[i].BridgeThinking[0].AStarGreedy[j];
                                Found = true;
                                return THIS;
                            }
                            else
                        ...
                        try
                        {
                            if (BridgesOnTable[i].BridgeThinking[0].AStarGreedy.Count == 0)
                            {
                                ...
                                for (int iii = 0; iii < BridgesOnTable[i].BridgeThinking[0].AStarGreedy.Count - 1; iii++)
                                    BridgesOnTable[i].BridgeThinking[0].AStarGreedy[iii].FoundOfLeafDepenOfKindFullGame(Order * -1, iAStarGreedy, ii, jj, ik, jjj, FOUND);
                        }
                        catch (Exception t)
                        {
                        }
                                ...
                                try
                                {
                                    ...
                                    if (FormRefrigtz.OrderPlate == Order && AStarGreedyi == 1 && UsePenaltyRegardMechnisamT)
                                        if ((SolderesOnTable[i].SoldierThinking[k].PenaltyRegardListSolder[j].IsPenaltyAction() != 0 && SolderesOnTable[i].SoldierThinking[k].PenaltyRegardListSolder[j].IsRewardAction() == 1 && AStarGreedyi == 1) || Do == 1 || AA)
                                        {
                                            ...
                                            FormRefrigtz.NextRow = SolderesOnTable[i].SoldierThinking[k].RowColumnSoldier[j][0];
                                            FormRefrigtz.NextColumn = SolderesOnTable[i].SoldierThinking[k].RowColumnSoldier[j][1];
                                ...
                                try
                                {
                                    ...
                                    if (FormRefrigtz.OrderPlate == Order && AStarGreedyi == 1 && UsePenaltyRegardMechnisamT)
                                        if ((ElephantOnTable[i].ElefantThinking[k].PenaltyRegardListElefant[j].IsPenaltyAction() != 0 && ElephantOnTable[i].ElefantThinking[k].PenaltyRegardListElefant[j].IsRewardAction() == 1 && AStarGreedyi == 1) || Do == 1 || AA)
                                        {
                                            ...
                                            FormRefrigtz.NextRow = ElephantOnTable[i].ElefantThinking[k].RowColumnElefant[j][0];
                                            FormRefrigtz.NextColumn = ElephantOnTable[i].ElefantThinking[k].RowColumnElefant[j][1];
                                ...
                                try
                                {
                                    ...
                                    if (FormRefrigtz.OrderPlate == Order && AStarGreedyi == 1 && UsePenaltyRegardMechnisamT)
                                        if ((HoursesOnTable[i].HourseThinking[k].PenaltyRegardListHourse[j].IsPenaltyAction() != 0 && HoursesOnTable[i].HourseThinking[k].PenaltyRegardListHourse[j].IsRewardAction() == 1 && AStarGreedyi == 1) || Do == 1 || AA)
                                        {
                                            ...
                                            FormRefrigtz.NextRow = HoursesOnTable[i].HourseThinking[k].RowColumnHourse[j][0];
                                            FormRefrigtz.NextColumn = HoursesOnTable[i].HourseThinking[k].RowColumnHourse[j][1];
                                ...
                                try
                                {
                                    ...
                                    if (FormRefrigtz.OrderPlate == Order && AStarGreedyi == 1 && UsePenaltyRegardMechnisamT)
                                        if ((BridgesOnTable[i].BridgeThinking[k].PenaltyRegardListBridge[j].IsPenaltyAction() != 0 && BridgesOnTable[i].BridgeThinking[k].PenaltyRegardListBridge[j].IsRewardAction() == 1 && AStarGreedyi == 1) || Do == 1 || AA)
                                        {
                                            ...
                                            FormRefrigtz.NextRow = BridgesOnTable[i].BridgeThinking[k].RowColumnBridge[j][0];
                                            FormRefrigtz.NextColumn = BridgesOnTable[i].BridgeThinking[k].RowColumnBridge[j][1];
                        ...
                        {
                            {
                                ...
                                if (FormRefrigtz.OrderPlate == Order && AStarGreedyi == 1 && UsePenaltyRegardMechnisamT)
                                    if ((MinisterOnTable[i].MinisterThinking[k].PenaltyRegardListMinister[j].IsPenaltyAction() != 0 && MinisterOnTable[i].MinisterThinking[k].PenaltyRegardListMinister[j].IsRewardAction() == 1 && AStarGreedyi == 1) || Do == 1 || AA)
                                    {
                                        ...
                                        FormRefrigtz.NextRow = MinisterOnTable[i].MinisterThinking[k].RowColumnMinister[j][0];
                                        FormRefrigtz.NextColumn = MinisterOnTable[i].MinisterThinking[k].RowColumnMinister[j][1];
                                ...
                                try
                                {
                                    ...
                                    if (FormRefrigtz.OrderPlate == Order && AStarGreedyi == 1 && UsePenaltyRegardMechnisamT)
                                        ...
                                        {    //Set Table and Huristic Value and Syntax.
                                            ...
                                            FormRefrigtz.NextRow = KingOnTable[i].KingThinking[k].RowColumnKing[j][0];
                                            FormRefrigtz.NextColumn = KingOnTable[i].KingThinking[k].RowColumnKing[j][1];
        ...
        delegate void IncreaseprogressBarRefregitzValueCalBack(ProgressBar Refregitz, Int32 value);
        private void IncreaseprogressBarRefregitzValue(ProgressBar Refregitz, Int32 value)
        {
            try
            {
                if (Refregitz.InvokeRequired)
                {
                    IncreaseprogressBarRefregitzValueCalBack d = new IncreaseprogressBarRefregitzValueCalBack(IncreaseprogressBarRefregitzValue);
        ...
        delegate void SetprogressBarRefregitzUpdateCalBack(ProgressBar Refregitz);
        private void SetprogressBarUpdate(ProgressBar Refregitz)
        {
            try
            {
                if (Refregitz.InvokeRequired)
                {
                    SetprogressBarRefregitzUpdateCalBack d = new SetprogressBarRefregitzUpdateCalBack(SetprogressBarUpdate);
        ...
        AllDraw InitiateAStarGreedytSodlerGray(int i, int j, int[,] Table, int DummyOrder, int DummyCurrentOrder, int iAStarGreedy, int ii, int jj, Color a, int[,] Tab, int Order, bool TB, bool FOUND//, ref Refrigtz.Timer timer, ref Refrigtz.Timer TimerColor, ref double Less
            )
        {
            List<Task> tH = new List<Task>();
            ...
            for (i = 0; i < SodierMidle; i++)
            {
                try
                {
                    ...
                    if (SolderesOnTable[i].SoldierThinking[0].TableListSolder.Count == 0)
                        SolderesOnTable[i] = new DrawSoldier(MovementsAStarGreedyHuristicFoundT, IgnoreSelfObjectsT, UsePenaltyRegardMechnisamT, BestMovmentsT, PredictHuristicT, OnlySelfT, AStarGreedyHuristicT, ArrangmentsChanged, ii, jj, a, Table, Order, false, i, ref THIS);
                    //If There is no Thinking Movments on Current Object 
        ...
        AllDraw InitiateAStarGreedytElephantGray(int i, int j, int[,] Table, int DummyOrder, int DummyCurrentOrder, int iAStarGreedy, int ii, int jj, Color a, int[,] Tab, int Order, bool TB, bool FOUND//, ref Refrigtz.Timer timer, ref Refrigtz.Timer TimerColor, ref double Less
            )
        {
            List<Task> tH = new List<Task>();
            for (i = 0; i < ElefantMidle; i++)
        ...
        AllDraw InitiateAStarGreedythHourseGray(int i, int j, int[,] Table, int DummyOrder, int DummyCurrentOrder, int iAStarGreedy, int ii, int jj, Color a, int[,] Tab, int Order, bool TB, bool FOUND//, ref Refrigtz.Timer timer, ref Refrigtz.Timer TimerColor, ref double Less
            )
        {
            List<Task> tH = new List<Task>();
            //For All Gray Hourse Objects.
        ...
        AllDraw InitiateAStarGreedythBridgeGray(int i, int j, int[,] Table, int DummyOrder, int DummyCurrentOrder, int iAStarGreedy, int ii, int jj, Color a, int[,] Tab, int Order, bool TB, bool FOUND//, ref Refrigtz.Timer timer, ref Refrigtz.Timer TimerColor, ref double Less
            )
        {
            List<Task> tH = new List<Task>();
                ...
                try
                {
                    ...
                    if (BridgesOnTable[i].BridgeThinking[0].TableListBridge.Count == 0)
                    {
                        ...
                        for (j = 0; j < AllDraw.BridgeMovments; j++)
                        {
                            ...
                            Clone(BridgesOnTable[i].BridgeThinking[0].AStarGreedy[BridgesOnTable[i].BridgeThinking[0].AStarGreedy.Count - 1]);
                            //Dummy = CopyRemeiningItems(Dummy, Order * -1);
                            if (!FormRefrigtz.Blitz)
        ...
        AllDraw InitiateAStarGreedythMinisterGray(int i, int j, int[,] Table, int DummyOrder, int DummyCurrentOrder, int iAStarGreedy, int ii, int jj, Color a, int[,] Tab, int Order, bool TB, bool FOUND//, ref Refrigtz.Timer timer, ref Refrigtz.Timer TimerColor, ref double Less
            )
        {
            List<Task> tH = new List<Task>();
            try
        ...
        AllDraw InitiateAStarGreedythKingGray(int i, int j, int[,] Table, int DummyOrder, int DummyCurrentOrder, int iAStarGreedy, int ii, int jj, Color a, int[,] Tab, int Order, bool TB, bool FOUND//, ref Refrigtz.Timer timer, ref Refrigtz.Timer TimerColor, ref double Less
            )
        {
            List<Task> tH = new List<Task>();
        ...
        AllDraw InitiateAStarGreedythSoldierBrown(int i, int j, int[,] Table, int DummyOrder, int DummyCurrentOrder, int iAStarGreedy, int ii, int jj, Color a, int[,] Tab, int Order, bool TB, bool FOUND//, ref Refrigtz.Timer timer, ref Refrigtz.Timer TimerColor, ref double Less
            )
        {
            List<Task> tH = new List<Task>();
        ...
        AllDraw InitiateAStarGreedythElephantBrown(int i, int j, int[,] Table, int DummyOrder, int DummyCurrentOrder, int iAStarGreedy, int ii, int jj, Color a, int[,] Tab, int Order, bool TB, bool FOUND//, ref Refrigtz.Timer timer, ref Refrigtz.Timer TimerColor, ref double Less
            )
        {
            List<Task> tH = new List<Task>();
            for (i = ElefantMidle; i < ElefantHigh; i++)
        ...
        AllDraw InitiateAStarGreedythHourseBrown(int i, int j, int[,] Table, int DummyOrder, int DummyCurrentOrder, int iAStarGreedy, int ii, int jj, Color a, int[,] Tab, int Order, bool TB, bool FOUND//, ref Refrigtz.Timer timer, ref Refrigtz.Timer TimerColor, ref double Less
            )
        {
            List<Task> tH = new List<Task>();
            for (i = HourseMidle; i < HourseHight; i++)
        ...
        AllDraw InitiateAStarGreedythBridgeBrown(int i, int j, int[,] Table, int DummyOrder, int DummyCurrentOrder, int iAStarGreedy, int ii, int jj, Color a, int[,] Tab, int Order, bool TB, bool FOUND//, ref Refrigtz.Timer timer, ref Refrigtz.Timer TimerColor, ref double Less
            )
        {
            List<Task> tH = new List<Task>();
            for (i = BridgeMidle; i < BridgeHigh; i++)
        ...
        AllDraw InitiateAStarGreedythMinisterBrown(int i, int j, int[,] Table, int DummyOrder, int DummyCurrentOrder, int iAStarGreedy, int ii, int jj, Color a, int[,] Tab, int Order, bool TB, bool FOUND//, ref Refrigtz.Timer timer, ref Refrigtz.Timer TimerColor, ref double Less
            )
        {
            List<Task> tH = new List<Task>();
            for (i = MinisterMidle; i < MinisterHigh; i++)
        ...
        AllDraw InitiateAStarGreedythKingBrown(int i, int j, int[,] Table, int DummyOrder, int DummyCurrentOrder, int iAStarGreedy, int ii, int jj, Color a, int[,] Tab, int Order, bool TB, bool FOUND//, ref Refrigtz.Timer timer, ref Refrigtz.Timer TimerColor, ref double Less
            )
        {
            List<Task> tH = new List<Task>();
            for (i = KingMidle; i < KingHigh; i++)
            ...
            )
        {
            ...
            if (iAStarGreedy >= 0 && iAStarGreedy < MaxDuringLevelThinkingCreation)
            {
                ...
                THIS.SetBoxText("\r\nMinimum Level During Thinking Tree Creation is " + MaxDuringLevelThinkingCreation.ToString());
                THIS.RefreshBoxText();
                ...
                //Initiate Of Local Variables.
                {
...

                    {
                        ...
                        if (Order == 1)
                        {
                            ...
                            Task array1 = new Task(() => this.InitiateAStarGreedytSodlerGray(i, j, Table, DummyOrder, DummyCurrentOrder, iAStarGreedy, ii, jj, a, Tab, Order, TB, FOUND));
                            array1.Start();
                            ...
                            Task array2 = new Task(() => this.InitiateAStarGreedytElephantGray(i, j, Table, DummyOrder, DummyCurrentOrder, iAStarGreedy, ii, jj, a, Tab, Order, TB, FOUND));
                            array2.Start();
                            ...
                            Task array3 = new Task(() => this.InitiateAStarGreedythHourseGray(i, j, Table, DummyOrder, DummyCurrentOrder, iAStarGreedy, ii, jj, a, Tab, Order, TB, FOUND));
                            array3.Start();
                            ...
                            Task array4 = new Task(() => this.InitiateAStarGreedythBridgeGray(i, j, Table, DummyOrder, DummyCurrentOrder, iAStarGreedy, ii, jj, a, Tab, Order, TB, FOUND));
                            array4.Start();
                            ...
                            Task array5 = new Task(() => this.InitiateAStarGreedythMinisterGray(i, j, Table, DummyOrder, DummyCurrentOrder, iAStarGreedy, ii, jj, a, Tab, Order, TB, FOUND));
                            array5.Start();
                            ...
                            Task array6 = new Task(() => this.InitiateAStarGreedythKingGray(i, j, Table, DummyOrder, DummyCurrentOrder, iAStarGreedy, ii, jj, a, Tab, Order, TB, FOUND));
                            array6.Start();
                        ...
                        else//Brown Order Considarations.
                        {
                            ...
                            Task array1 = new Task(() => this.InitiateAStarGreedythSoldierBrown(i, j, Table, DummyOrder, DummyCurrentOrder, iAStarGreedy, ii, jj, a, Tab, Order, TB, FOUND));
                            array1.Start();
                            Object tttt1 = new Object(); lock (tttt1) { ThB.Add(array1); }
                            ...
                            Task array2 = new Task(() => this.InitiateAStarGreedythElephantBrown(i, j, Table, DummyOrder, DummyCurrentOrder, iAStarGreedy, ii, jj, a, Tab, Order, TB, FOUND));
                            array2.Start();
                            Object tttt2 = new Object(); lock (tttt2) { ThB.Add(array2); }
                            //Progressing.
                            try
                            ...
                            Task array3 = new Task(() => this.InitiateAStarGreedythHourseBrown(i, j, Table, DummyOrder, DummyCurrentOrder, iAStarGreedy, ii, jj, a, Tab, Order, TB, FOUND));
                            array3.Start();
                            Object tttt3 = new Object(); lock (tttt3) { ThB.Add(array3); }
                            ...
                            Task array4 = new Task(() => this.InitiateAStarGreedythBridgeBrown(i, j, Table, DummyOrder, DummyCurrentOrder, iAStarGreedy, ii, jj, a, Tab, Order, TB, FOUND));
                            array4.Start();
                            Object tttt4 = new Object(); lock (tttt4) { ThB.Add(array4); }
                            ...
                            Task array5 = new Task(() => this.InitiateAStarGreedythMinisterBrown(i, j, Table, DummyOrder, DummyCurrentOrder, iAStarGreedy, ii, jj, a, Tab, Order, TB, FOUND));
                            array5.Start();
                            Object tttt5 = new Object(); lock (tttt5) { ThB.Add(array5); }
                            //Progressing.
                            try
                            ...
                            Task array6 = new Task(() => this.InitiateAStarGreedythKingBrown(i, j, Table, DummyOrder, DummyCurrentOrder, iAStarGreedy, ii, jj, a, Tab, Order, TB, FOUND));
                            array6.Start();
                            Object tttt6 = new Object(); lock (tttt6) { ThB.Add(array6); }
             ...
             */
            {
                ...
                else
                {
                    ...
                    Task ob = new Task(() =>Do = this.FullGameThinkingTree(Order * -1, iAStarGreedy, ii, jj, ik, j, false));
                ...
                /*  if (Order == 1)
                  {
                      ...
                      try
                      {
                      ...
                      catch (Exception t) { } for (i = 0; i < HourseMidle; i++)
                          try
                          {
                          ...
                          catch (Exception t) { } for (i = 0; i < BridgeMidle; i++)
                          try
                          {
                              for (j = 0; j < BridgesOnTable[i].BridgeThinking[0].AStarGreedy.Count; i++)
                                  BridgesOnTable[i].BridgeThinking[0].AStarGreedy[0].InitiateAStarGreedyt(iAStarGreedy, ii, jj, a, Tab, Order * -1, TB, FOUND);
                          }
                          catch (Exception t) { } for (i = 0; i < MinisterMidle; i++)
                          try
                          {
                          ...
                          catch (Exception t) { } for (i = 0; i < KingMidle; i++)
                          try
                          {
        ...
        void BlitzGameThinkingTreeBridgeGray(ref double PreviousLessB, ref int[] Index, ref int[] jIndex, int Order, int iAStarGreedy, int ik, int j, bool FOUND)
        {
            //Bridge.
        ...
        void BlitzGameTreeCreationThinkingTreeBridge(Color a, int[] Index, int[] jIndex, int Order, int iAStarGreedy, int ik, int j, bool FOUND)
        {
            List<Task> tHA = new List<Task>();
            if (Index[3] != -1)
            {
        ...
        int FullGameMakimgBlitz(ref int Index, ref int jIndex, int Order)
        {
            ...
            if (Order == 1)
            {
                BlitzGameThinkingTreeSolderGray(ref PS, ref index, ref jindex, Order, 0, 0, 0, false);
                BlitzGameThinkingTreeElephantGray(ref PE, ref index, ref jindex, Order, 0, 0, 0, false);
                BlitzGameThinkingTreeHourseGray(ref PH, ref index, ref jindex, Order, 0, 0, 0, false);
                BlitzGameThinkingTreeBridgeGray(ref PB, ref index, ref jindex, Order, 0, 0, 0, false);
                BlitzGameThinkingTreeMinisterGray(ref PM, ref index, ref jindex, Order, 0, 0, 0, false);
                BlitzGameThinkingTreeKingGray(ref PK, ref index, ref jindex, Order, 0, 0, 0, false);

            }
            else
            {
                BlitzGameThinkingTreeSolderBrown(ref PS, ref index, ref jindex, Order, 0, 0, 0, false);
                BlitzGameThinkingTreeElephantBrown(ref PE, ref index, ref jindex, Order, 0, 0, 0, false);
                BlitzGameThinkingTreeHourseBrown(ref PH, ref index, ref jindex, Order, 0, 0, 0, false);
                BlitzGameThinkingTreeBridgeBrown(ref PB, ref index, ref jindex, Order, 0, 0, 0, false);
                BlitzGameThinkingTreeMinisterBrown(ref PM, ref index, ref jindex, Order, 0, 0, 0, false);
                BlitzGameThinkingTreeKingBrown(ref PK, ref index, ref jindex, Order, 0, 0, 0, false);
            }
            int JI = MaxOfThreeHuristic(PS, PE, PH, PB, PM, PK);
            if (JI != -1)
            {
                Kind = JI;
                Index = index[JI];
        ...
        void BlitzGameThinkingTreeBridgeBrown(ref double PreviousLessB, ref int[] Index, ref int[] jIndex, int Order, int iAStarGreedy, int ik, int j, bool FOUND)
        { //Bridges.
        ...
        {             //Initiatye Variables.
            ...
            if (Order == 1)
            {
                ...
                Index[3] = -1;
                BlitzGameThinkingTreeBridgeGray(ref  PreviousLessB, ref Index, ref  jIndex, Order, iAStarGreedy, ik, j, FOUND);
                Index[4] = -1;
                ...
                if (JI != -1)
                {
                    ...
                    //ChessRules.CurrentOrder *= -1;
                    if (JI == 3)
                        BlitzGameTreeCreationThinkingTreeBridge(a, Index, jIndex, Order * -1, iAStarGreedy, ik, j, FOUND);
            ...
            else
            {
                ...
                Index[3] = -1;
                BlitzGameThinkingTreeBridgeBrown(ref  PreviousLessB, ref Index, ref  jIndex, Order, iAStarGreedy, ik, j, FOUND);
                Index[4] = -1;
        ...
        {
            int S = 0;
            while (!SolderesOnTable[ik].SoldierThinking[0].ThinkingFinished) { Thread.Sleep(100);}// S += 100; if (FormRefrigtz.Blitz) { if (S > ThresholdBlitz)break; } else { if (S > ThresholdFullGame)break; } }
            List<Task> tHA = new List<Task>();
            bool Do = false;
            int j;
            ...
            for (j = 0; j < SolderesOnTable[ik].SoldierThinking[0].TableListSolder.Count; j++)
            {
                if (SolderesOnTable[ik].SoldierThinking[0].PenaltyRegardListSolder[j].IsPenaltyAction() != 0)
                {
                    ...
                    // if (Index[0] != -1)
                    {
                        ...
                        {
                            Do = true;
                            ii = SolderesOnTable[ik].SoldierThinking[0].RowColumnSoldier[j][0];
                            jj = SolderesOnTable[ik].SoldierThinking[0].RowColumnSoldier[j][1];
        ...
        {
            int S = 0;
            while (!ElephantOnTable[ik].ElefantThinking[0].ThinkingFinished) { Thread.Sleep(100);}// S += 100; if (FormRefrigtz.Blitz) { if (S > ThresholdBlitz)break; } else { if (S > ThresholdFullGame)break; } }
            List<Task> tHA = new List<Task>();
            bool Do = false;
            int j; for (j = 0; j < ElephantOnTable[ik].ElefantThinking[0].TableListElefant.Count; j++)
            {
                if (ElephantOnTable[ik].ElefantThinking[0].PenaltyRegardListElefant[j].IsPenaltyAction() != 0)
                {
                    //if (Index[1] != -1)
                    {
                        ...
                        {
                            ii = ElephantOnTable[ik].ElefantThinking[0].RowColumnElefant[j][0];
                            jj = ElephantOnTable[ik].ElefantThinking[0].RowColumnElefant[j][1];
        ...
        bool FullGameThinkingTreeHourse(int ik, Color a, int Order, int iAStarGreedy, int ii, int jj, int ik1, int j1, bool FOUND)
        {
            ...
            int S = 0;
            while (!HoursesOnTable[ik].HourseThinking[0].ThinkingFinished) { Thread.Sleep(100);}// S += 100; if (FormRefrigtz.Blitz) { if (S > ThresholdBlitz)break; } else { if (S > ThresholdFullGame)break; } }
            List<Task> tHA = new List<Task>();
            bool Do = false;
            int j; for (j = 0; j < HoursesOnTable[ik].HourseThinking[0].TableListHourse.Count; j++)
            {
                ...
                if (HoursesOnTable[ik].HourseThinking[0].PenaltyRegardListHourse[j].IsPenaltyAction() != 0)
                {
                    //if (Index[2] != -1)
                    {
                        ...
                        {
                            ii = HoursesOnTable[ik].HourseThinking[0].RowColumnHourse[j][0];
                            jj = HoursesOnTable[ik].HourseThinking[0].RowColumnHourse[j][1];
        ...
        bool FullGameThinkingTreeBridge(int ik, Color a, int Order, int iAStarGreedy, int ii, int jj, int ik1, int j1, bool FOUND)
        {
            int S = 0;
            while (!BridgesOnTable[ik].BridgeThinking[0].ThinkingFinished) { Thread.Sleep(100); }// S += 100; if (FormRefrigtz.Blitz) { if (S > ThresholdBlitz)break; } else { if (S > ThresholdFullGame)break; } }
            List<Task> tHA = new List<Task>();
            bool Do = false;
            int j; for (j = 0; j < BridgesOnTable[ik].BridgeThinking[0].TableListBridge.Count; j++)
            {
                if (BridgesOnTable[ik].BridgeThinking[0].PenaltyRegardListBridge[j].IsPenaltyAction() != 0)
                {
                    ...
                    //if (Index[3] != -1)
                    {
                        ...
                        if (BridgesOnTable[ik].BridgeThinking[0].AStarGreedy == null)
                            BridgesOnTable[ik].BridgeThinking[0].AStarGreedy = new List<AllDraw>();
                        ...
                        BridgesOnTable[ik].BridgeThinking[0].AStarGreedy[BridgesOnTable[ik].BridgeThinking[0].AStarGreedy.Count - 1].SetRowColumnFinishedWait();
                        ...
                        {
                            ii = BridgesOnTable[ik].BridgeThinking[0].RowColumnBridge[j][0];
                            jj = BridgesOnTable[ik].BridgeThinking[0].RowColumnBridge[j][1];
        ...
        bool FullGameThinkingTreeBridgeGray(Color a, int Order, int iAStarGreedy, int ii, int jj, int ik1, int j1, bool FOUND)
        {
            bool Do = false;
            int ik;
            //Bridge.
            try
            {
                for (ik = 0; ik < BridgeMidle; ik++)
                {
                    if (ik >= BridgeMidle)
                        continue;
                    if (BridgesOnTable[ik] == null)
                        continue;
                    Do = FullGameThinkingTreeBridge(ik, a, Order, iAStarGreedy, ii, jj, ik1, j1, FOUND);
                }
            }
            catch (Exception t) { }
            return Do;
        ...
        {
            int S = 0;
            while (!MinisterOnTable[ik].MinisterThinking[0].ThinkingFinished) { Thread.Sleep(100);}// S += 100; if (FormRefrigtz.Blitz) { if (S > ThresholdBlitz)break; } else { if (S > ThresholdFullGame)break; } }
            List<Task> tHA = new List<Task>();
            bool Do = false;
            int j;
            for (j = 0; j < MinisterOnTable[ik].MinisterThinking[0].TableListMinister.Count; j++)
            {
                ...
                if (MinisterOnTable[ik].MinisterThinking[0].PenaltyRegardListMinister[j].IsPenaltyAction() != 0)
                {
                    //if (Index[4] != -1)
                    {
                        ...
                        {
                            Do = true;
                            ii = MinisterOnTable[ik].MinisterThinking[0].RowColumnMinister[j][0];
                            jj = MinisterOnTable[ik].MinisterThinking[0].RowColumnMinister[j][1];
        ...
        {
            int S = 0;
            while (!KingOnTable[ik].KingThinking[0].ThinkingFinished) { Thread.Sleep(100);}// S += 100; if (FormRefrigtz.Blitz) { if (S > ThresholdBlitz)break; } else { if (S > ThresholdFullGame)break; } }
            List<Task> tHA = new List<Task>();
            bool Do = false;
            int j;
            for (j = 0; j < KingOnTable[ik].KingThinking[0].TableListKing.Count; j++)
            {
                if (KingOnTable[ik].KingThinking[0].PenaltyRegardListKing[j].IsPenaltyAction() != 0)
                {
                    ...
                    {
                        Do = true;
                        ii = KingOnTable[ik].KingThinking[0].RowColumnKing[j][0];
                        jj = KingOnTable[ik].KingThinking[0].RowColumnKing[j][1];
        ...
        bool FullGameThinkingTreeBridgeBrown(Color a, int Order, int iAStarGreedy, int ii, int jj, int ik1, int j1, bool FOUND)
        {
            bool Do = false;
            int ik, j;
            //Bridges.
        ...
        bool FullGameThinkingTree(int Order, int iAStarGreedy, int ii, int jj, int ik1, int j1, bool FOUND)
        {
            ...
            Index = -1;
            jindex = -1;
            Kind = FullGameMakimgBlitz(ref Index, ref jindex, Order);
            ...
            if (Order == -1)
            {
                ...
                //Soldeir
                //Initiatye Variables.
                Task array1 = new Task(() => Do |= this.FullGameThinkingTreeSoldierGray(a, Order, iAStarGreedy, ii, jj, ik1, j1, FOUND));
                array1.Start();
                ...
                Task array2 = new Task(() => Do |= this.FullGameThinkingTreeElephantGray(a, Order, iAStarGreedy, ii, jj, ik1, j1, FOUND));
                array2.Start();
                ...
                Task array3 = new Task(() => Do |= this.FullGameThinkingTreeHourseGray(a, Order, iAStarGreedy, ii, jj, ik1, j1, FOUND));
                array3.Start();
                ...
                Task array4 = new Task(() => Do |= this.FullGameThinkingTreeBridgeGray(a, Order, iAStarGreedy, ii, jj, ik1, j1, FOUND));
                array4.Start();
                ...
                Task array5 = new Task(() => Do |= this.FullGameThinkingTreeMinisterGray(a, Order, iAStarGreedy, ii, jj, ik1, j1, FOUND));
                array5.Start();
                ...
                Task array6 = new Task(() => Do |= this.FullGameThinkingTreeKingGray(a, Order, iAStarGreedy, ii, jj, ik1, j1, FOUND));
                array6.Start();
            ...
            else
            {
                ...
                //Soldeir
                //Initiatye Variables.
                Task array1 = new Task(() => Do |= this.FullGameThinkingTreeSoldierBrown(a, Order, iAStarGreedy, ii, jj, ik1, j1, FOUND));
                array1.Start();
                Object tttt1 = new Object(); lock (tttt1) { TH.Add(array1); }
                ...
                Task array2 = new Task(() => Do |= this.FullGameThinkingTreeElephantBrown(a, Order, iAStarGreedy, ii, jj, ik1, j1, FOUND));
                array2.Start();
                Object tttt2 = new Object(); lock (tttt2) { TH.Add(array2); }
                ...
                Task array3 = new Task(() => Do |= this.FullGameThinkingTreeHourseBrown(a, Order, iAStarGreedy, ii, jj, ik1, j1, FOUND));
                array3.Start();
                Object tttt3 = new Object(); lock (tttt3) { TH.Add(array3); }
                ...
                Task array4 = new Task(() => Do |= this.FullGameThinkingTreeBridgeBrown(a, Order, iAStarGreedy, ii, jj, ik1, j1, FOUND));
                array4.Start();
                Object tttt4 = new Object(); lock (tttt4) { TH.Add(array4); }
                ...
                Task array5 = new Task(() => Do |= this.FullGameThinkingTreeMinisterBrown(a, Order, iAStarGreedy, ii, jj, ik1, j1, FOUND));
                array5.Start();
                Object tttt5 = new Object(); lock (tttt5) { TH.Add(array5); }
                ...
                Task array6 = new Task(() => Do |= this.FullGameThinkingTreeKingBrown(a, Order, iAStarGreedy, ii, jj, ik1, j1, FOUND));
                array6.Start();
                Object tttt6 = new Object(); lock (tttt6) { TH.Add(array6); }
            }
            Parallel.ForEach(TH, items => Task.WaitAny(items));
        ...
        public int[,] HuristicCurrentTable(AllDraw ADra, Color a, int Order)
        {
            ...
            Tab = HuristicAStarGreedySearch(0, Ad, a, Order, true);
        ...
        public AllDraw CopyRemeiningItems(AllDraw ADummy, int Order)
        {
            ...
            for (int i = 0; i < SodierHigh; i++)
            {
                try
                {
                    ...
                    Dummy.SolderesOnTable[i] = new DrawSoldier(MovementsAStarGreedyHuristicFoundT, IgnoreSelfObjectsT, UsePenaltyRegardMechnisamT, BestMovmentsT, PredictHuristicT, OnlySelfT, AStarGreedyHuristicT, ArrangmentsChanged, SolderesOnTable[i].Row, SolderesOnTable[i].Column, SolderesOnTable[i].color, SolderesOnTable[i].Table, SolderesOnTable[i].Order, false, SolderesOnTable[i].Current, ref THIS);
                }
                catch (Exception t) { }
            }
        ...
        public void RecoonstructADraw(ref List<AllDraw> ADrawAll)
        {
            ...
            if (ADraw.Count == 0)
                return;
            //Adding Operations.
            ADrawAll.Add(ADraw[0]);
            //Recursive Main Method.
            ADraw[0].RecoonstructADraw(ref ADrawAll);
        }
        //Main Initiate Thinking Method.
        public void Initiate(int ii, int jj, Color a, int[,] Table, int Order, bool TB, ref Refrigtz.Timer timer, ref Refrigtz.Timer TimerColor, bool FOUND)
        {
            var parallelOptions = new ParallelOptions();
            parallelOptions.MaxDegreeOfParallelism = PlatformHelper.ProcessorCount;
            ...
            if (!AllDraw.AStarGreadyFirstSearch)
            {
                ...
                for (int i = 0; i < 1; i++)
                {
                    ...
                    InitiateForEveryKindThingHome(new AllDraw(MovementsAStarGreedyHuristicFoundT, IgnoreSelfObjectsT, UsePenaltyRegardMechnisamT, BestMovmentsT, PredictHuristicT, OnlySelfT, AStarGreedyHuristicT, ArrangmentsChanged, ref THIS), (int)SolderesOnTable[In].Row, (int)SolderesOnTable[In].Column, a, Table, Order, false, In);
                    ...
                    if (ADraw.Count > 0)
                    {
                        ...
                        Tab = ADraw[0].Huristic(ADraw, a, i, Order);
                    }
            ...
            else
            {
                ...
                if (!FOUND)
                {
                    ...
                    Clone(THISDummy.accessDraw);
                    THISDummy.Dispose();


                    THISDummy.accessDraw.THIS = THIS;
                    AStarGreedyIndexVlue = 0;
                    ThinkingChess.NotSolvedKingDanger = false;
                    LoopHuristicIndex = 0;
                ...
                ChessRules.CurrentOrder = Current;
                Order = DummyOrder;
                Task ob = new Task(() => THISDummy.accessDraw.InitiateAStarGreedyt(MaxAStarGreedy, ii, jj, a, CurrentTable, Order, false, FOUND));
                Object ttttt = new Object();
                lock (ttttt) { ob.Start(); ob.Wait(); }
                //while (ThinkingChess.BeginThread > ThinkingChess.EndThread) ;
