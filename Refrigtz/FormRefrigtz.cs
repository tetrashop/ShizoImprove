        ...
        void Movements()
        {
            ...
            lock (OO)
            {
                ...
                lock (O)
                {
                    if (!Quantum)
                    {
                        Thread t = new Thread(new ThreadStart(MovementRefrigitzDLL));
                        t.Start();
                        t.Join();
                    }
                    else
                    {
                        Thread t = new Thread(new ThreadStart(MovementQuantum));
                        t.Start();
                        t.Join();
