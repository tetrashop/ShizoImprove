namespace ContourAnalysisDemo
{
    ...
    public class MainForm : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.nudMinContourLength.Maximum = new decimal(new int[] { 400,0,0,0 });
            ...
            this.nudMinContourLength.Value = new decimal(new int[] { 15,0,0,0 });
            ...
            this.nudMinContourArea.Maximum = new decimal(new int[] { 400,0,0,0 });
            ...
            this.nudMinContourArea.Value = new decimal(new int[] { 10,0,0,0 });
            ...
            this.nudAdaptiveThBlockSize.Maximum = new decimal(new int[] { 400,0,0,0 });
            this.nudAdaptiveThBlockSize.Minimum = new decimal(new int[] { 1,0,0,0 });
            ...
            this.nudAdaptiveThBlockSize.Value = new decimal(new int[] { 4,0,0,0 });
